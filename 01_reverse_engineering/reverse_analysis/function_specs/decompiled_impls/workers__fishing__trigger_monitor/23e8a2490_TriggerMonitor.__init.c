/* ===== 23e8a2490 workers.fishing.trigger_monitor:319 ===== */
/* ghidra_name=FUN_23e8a2490 entry=23e8a2490 size=4448 */

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

longlong * FUN_23e8a2490(longlong param_1,undefined8 param_2,undefined8 *param_3)

{
  ...
  plVar9 = _DAT_23eede440;
  pcVar1 = (code *)param_3[1];
  plVar2 = (longlong *)*param_3;
  local_68 = (longlong *)0x0;
  local_78._0_8_ = 0;
  local_78._8_8_ = 0;
  if (_DAT_23eede440 == (longlong *)0x0) {
LAB_23e8a24f3:
    _DAT_23eede440 = (longlong *)FUN_23e91f3b0(param_1,_DAT_23eede438,DAT_23eede5a0,0x30);
  }
  else {
    lVar15 = *_DAT_23eede440;
    if (1 < lVar15) {
      *_DAT_23eede440 = lVar15 + -1;
      goto LAB_23e8a24f3;
    }
    if (_DAT_23eede440[2] != 0) {
      *_DAT_23eede440 = lVar15 + -1;
      if (lVar15 + -1 == 0) {
  ...
  plVar4 = _DAT_23eede440;
  lVar15 = *(longlong *)(param_1 + 0x38);
  plVar9 = _DAT_23eede440 + 9;
  lVar3 = *(longlong *)(lVar15 + 8);
  _DAT_23eede440[0xf] = lVar3;
  ...
  *plVar4 = *plVar4 + 1;
  uVar19 = _DAT_23eedc270;
  *(undefined4 *)(plVar4 + 8) = 0;
  plVar9 = (longlong *)FUN_23e8bc2f0(plVar2,uVar19);
  if (plVar9 == (longlong *)0x0) {
    ...
    *(undefined1 (*) [16])(param_1 + 0x60) = (undefined1  [16])0x0;
    ...
    goto joined_r0x00023e8a2f97;
  }
  plVar10 = (longlong *)FUN_23e8bc2f0(plVar2,_DAT_23eedc0a8);
...
LAB_23e8a2c66:
  ...
  if (plVar12 == (longlong *)0x0) goto LAB_23e8a2cf0;
...
LAB_23e8a30d0:
    ...
    *plVar12 = *plVar12 + -1;
    ...
    plVar13 = (longlong *)FUN_23a38cc10(param_1,plVar9,_DAT_23eedc1d8);
    *plVar9 = *plVar9 + -1;
    if (*plVar9 == 0) {
      (**(code **)(plVar9[1] + 0x30))(plVar9);
    }
    if (plVar13 == (longlong *)0x0) goto LAB_23e8a30d0;
    *(undefined4 *)(plVar4 + 5) = 0x148;
    local_88 = pcVar11;
    plStack_80 = plVar13;
...
LAB_23e8a2cf0:
      ...
      *plVar9 = *plVar9 + -1;
      ...
      if (plVar13 == (longlong *)0x0) goto LAB_23e8a2cf0;
        ...
        if (((plVar12 != (longlong *)0x0) ||
          ...
          *plVar13 = *plVar13 + -1;
          ...
          if (iVar8 == 1) {
            ...
            PyDict_SetItem(plVar9,uVar19,plVar14);
            PyDict_SetItem(plVar9,_DAT_23eedc290,plVar12);
            PyDict_SetItem(plVar10,_DAT_23eedc1d8,plVar9);
            *plVar9 = *plVar9 + -1;
            if (*plVar9 == 0) {
              (**(code **)(plVar9[1] + 0x30))(plVar9);
            }
          ...
          if (plVar13 == (longlong *)0x0) goto LAB_23e8a3320;
          plVar9 = (longlong *)FUN_23e8bc2f0(plVar2,_DAT_23eedc0f0);
          if (plVar9 == (longlong *)0x0) {
LAB_23e8a32b0:
            local_78._0_8_ = *(undefined8 *)(param_1 + 0x60);
            ...
            *plVar13 = *plVar13 + -1;
            ...
            plVar16 = (longlong *)FUN_23a38cc10(param_1,plVar9,_DAT_23eedc1e0);
            *plVar9 = *plVar9 + -1;
            if (*plVar9 == 0) {
              (**(code **)(plVar9[1] + 0x30))(plVar9);
            }
            if (plVar16 == (longlong *)0x0) goto LAB_23e8a32b0;
            *(undefined4 *)(plVar4 + 5) = 0x14d;
            local_88 = pcVar11;
            plStack_80 = plVar16;
...
LAB_23e8a3320:
              ...
              *plVar9 = *plVar9 + -1;
              ...
              if (plVar13 == (longlong *)0x0) goto LAB_23e8a3320;
              plVar16 = (longlong *)(**(code **)(plVar13[1] + 0xe0))(plVar13);
              if ((plVar16 == (longlong *)0x0) &&
                 (plVar16 = (longlong *)FUN_23a3c1b70(param_1,local_78,0,2),
                ...
                if (((plVar17 != (longlong *)0x0) ||
                    (plVar17 = (longlong *)FUN_23a3c1b70(param_1,local_78,1,2),
                    plVar17 != (longlong *)0x0)) &&
                   (cVar7 = FUN_23a3884a0(param_1,local_78,plVar13,2), cVar7 != '\0')) {
                  *plVar13 = *plVar13 + -1;
                  if (*plVar13 == 0) {
                  ...
                  *plVar17 = *plVar17 + -1;
                  ...
                  if (lVar15 == 0) {
                    ...
                    iVar8 = FUN_23e97d0c0(plVar16,lVar15);
                    uVar19 = _DAT_23eedc288;
                    if (iVar8 != -1) {
                      if (iVar8 == 1) {
                        plVar9 = (longlong *)_PyDict_NewPresized(2);
                        PyDict_SetItem(plVar9,uVar19,plVar16);
                        PyDict_SetItem(plVar9,_DAT_23eedc290,plVar17);
                        PyDict_SetItem(plVar10,_DAT_23eedc1e0,plVar9);
                        *plVar9 = *plVar9 + -1;
                        if (*plVar9 == 0) {
                          (**(code **)(plVar9[1] + 0x30))(plVar9);
                        }
...
joined_r0x00023e8a2f97:
  ...
  if (_DAT_23eede440 == plVar4) {
    *plVar4 = *plVar4 + -1;
    if (*plVar4 == 0) {
      (**(code **)(plVar4[1] + 0x30))(plVar4);
    }
    _DAT_23eede440 = (longlong *)0x0;
  }
  lVar15 = *(longlong *)(*(longlong *)(param_1 + 0x38) + 8);
  plVar9 = *(longlong **)(lVar15 + 0x28);
  plVar4 = (longlong *)plVar9[2];
  ...
  *plVar9 = *plVar9 + -1;
  ...
  local_78 = CONCAT88(uVar20,uVar19);
  *plVar2 = *plVar2 + -1;
  local_68 = plVar4;
  if (*plVar2 == 0) {
    (**(code **)(plVar2[1] + 0x30))(plVar2);
