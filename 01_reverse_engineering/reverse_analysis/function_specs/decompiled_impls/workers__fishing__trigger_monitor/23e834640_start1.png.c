/* ===== 23e834640 workers.fishing.trigger_monitor:78 ===== */
/* ghidra_name=FUN_23e834640 entry=23e834640 size=3216 */

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

longlong * FUN_23e834640(longlong param_1,undefined8 param_2,undefined8 *param_3)

{
  ...
  plVar11 = _DAT_23eede560;
  plVar1 = (longlong *)*param_3;
  plStack_68 = (longlong *)0x0;
  auStack_78._0_8_ = 0;
  auStack_78._8_8_ = 0;
  if (_DAT_23eede560 == (longlong *)0x0) {
LAB_23e834694:
    _DAT_23eede560 = (longlong *)FUN_23e91f3b0(param_1,_DAT_23eede558,DAT_23eede5a0,0x28);
  }
  else {
    lVar12 = *_DAT_23eede560;
    if (1 < lVar12) {
      *_DAT_23eede560 = lVar12 + -1;
      goto LAB_23e834694;
    }
    if (_DAT_23eede560[2] != 0) {
      *_DAT_23eede560 = lVar12 + -1;
      if (lVar12 + -1 == 0) {
  ...
  plVar3 = _DAT_23eede560;
  lVar12 = *(longlong *)(param_1 + 0x38);
  plVar11 = _DAT_23eede560 + 9;
  lVar2 = *(longlong *)(lVar12 + 8);
  _DAT_23eede560[0xf] = lVar2;
...
LAB_23e834f30:
  ...
  if (iVar9 == 0) {
LAB_23e834757:
    plVar17 = DAT_23eedbf40;
    plVar16 = (longlong *)0x0;
    plVar14 = (longlong *)0x0;
    plVar13 = (longlong *)0x0;
    plVar11 = (longlong *)0x0;
    *DAT_23eedbf40 = *DAT_23eedbf40 + 1;
LAB_23e83476c:
  ...
  lVar12 = FUN_23e8db7b0();
  if (lVar12 == 0) {
    FUN_23e915740(param_1,auStack_78,DAT_23eedbee0);
  }
  else {
    plVar13 = (longlong *)FUN_23e8bc2f0(lVar12,DAT_23eedbf38);
    ...
    plVar11 = (longlong *)FUN_23e8bc2f0(plVar1,DAT_23eedbec8);
    if (plVar11 != (longlong *)0x0) {
      ...
      *plVar14 = *plVar14 + -1;
      ...
      if (uVar10 == 0xffffffff) goto LAB_23e834f30;
      if ((uVar10 & 1) == 0) goto LAB_23e834757;
      lVar12 = FUN_23e8db7b0();
      if (lVar12 == 0) {
        FUN_23e915740(param_1,auStack_78,DAT_23eedbee0);
        plVar17 = plStack_68;
        ...
        plVar11 = (longlong *)FUN_23e8bc2f0(lVar12,DAT_23eedbf48);
        if (plVar11 != (longlong *)0x0) {
...
LAB_23e834cc2:
  ...
  if (_DAT_23eede560 == plVar3) {
    *plVar3 = *plVar3 + -1;
    if (*plVar3 == 0) {
      (**(code **)(plVar3[1] + 0x30))(plVar3);
    }
    _DAT_23eede560 = (longlong *)0x0;
  }
  lVar12 = *(longlong *)(*(longlong *)(param_1 + 0x38) + 8);
  plVar3 = *(longlong **)(lVar12 + 0x28);
