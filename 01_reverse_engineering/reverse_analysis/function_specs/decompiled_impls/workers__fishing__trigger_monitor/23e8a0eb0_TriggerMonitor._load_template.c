/* ===== 23e8a0eb0 workers.fishing.trigger_monitor:294 ===== */
/* ghidra_name=FUN_23e8a0eb0 entry=23e8a0eb0 size=5484 */

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

longlong * FUN_23e8a0eb0(longlong param_1,undefined8 param_2,undefined8 *param_3)

{
  ...
  plVar9 = _DAT_23eede450;
  pcVar1 = (code *)param_3[1];
  plVar2 = (longlong *)*param_3;
  local_68 = (longlong *)0x0;
  local_78._0_8_ = 0;
  local_78._8_8_ = 0;
  if (_DAT_23eede450 == (longlong *)0x0) {
LAB_23e8a0f16:
    _DAT_23eede450 = (longlong *)FUN_23e91f3b0(param_1,_DAT_23eede448,DAT_23eede5a0,0x30);
  }
  else {
    lVar15 = *_DAT_23eede450;
    if (1 < lVar15) {
      *_DAT_23eede450 = lVar15 + -1;
      goto LAB_23e8a0f16;
    }
    if (_DAT_23eede450[2] != 0) {
      *_DAT_23eede450 = lVar15 + -1;
      if (lVar15 + -1 == 0) {
  ...
  plVar4 = _DAT_23eede450;
  lVar15 = *(longlong *)(param_1 + 0x38);
  plVar9 = _DAT_23eede450 + 9;
  lVar3 = *(longlong *)(lVar15 + 8);
  _DAT_23eede450[0xf] = lVar3;
  ...
  *(undefined4 *)(plVar4 + 8) = 0;
  ...
  if (plVar9 == (longlong *)0x0) {
    ...
    *(undefined1 (*) [16])(param_1 + 0x60) = (undefined1  [16])0x0;
    ...
    goto joined_r0x00023e8a1b7a;
  }
  plVar10 = (longlong *)FUN_23e8bc2f0(plVar2,_DAT_23eedc098);
  ...
  *(undefined4 *)(plVar4 + 5) = 0x128;
  local_88 = pcVar1;
  plStack_80 = plVar10;
  pcVar11 = (code *)FUN_23e94ed00(param_1,plVar9,&local_88);
  *plVar9 = *plVar9 + -1;
  if (*plVar9 == 0) {
    (**(code **)(plVar9[1] + 0x30))(plVar9);
  }
...
LAB_23e8a1822:
  ...
  if (plVar12 == (longlong *)0x0) goto LAB_23e8a18b0;
...
LAB_23e8a1cb0:
    ...
    *plVar12 = *plVar12 + -1;
    ...
    plVar13 = (longlong *)FUN_23a38cc10(param_1,plVar9,_DAT_23eedc1a0);
    *plVar9 = *plVar9 + -1;
    if (*plVar9 == 0) {
      (**(code **)(plVar9[1] + 0x30))(plVar9);
    }
    if (plVar13 == (longlong *)0x0) goto LAB_23e8a1cb0;
    *(undefined4 *)(plVar4 + 5) = 0x12f;
    local_88 = pcVar11;
    plStack_80 = plVar13;
    plVar9 = (longlong *)FUN_23e94ed00(param_1,plVar12,&local_88);
    *plVar12 = *plVar12 + -1;
    if (*plVar12 == 0) {
      (**(code **)(plVar12[1] + 0x30))(plVar12);
    }
...
LAB_23e8a18b0:
      ...
      *plVar9 = *plVar9 + -1;
      ...
      if (plVar13 == (longlong *)0x0) goto LAB_23e8a18b0;
      plVar14 = (longlong *)(**(code **)(plVar13[1] + 0xe0))(plVar13);
      if ((plVar14 == (longlong *)0x0) &&
         (plVar14 = (longlong *)FUN_23a3c1b70(param_1,local_78,0,2), plVar14 == (longlong *)0x0)) {
        plVar12 = (longlong *)0x0;
      }
      else {
        ...
        if (((plVar12 != (longlong *)0x0) ||
           ...
           && (cVar7 = FUN_23a3884a0(param_1,local_78,plVar13,2), cVar7 != '\0')) {
          *plVar13 = *plVar13 + -1;
          if (*plVar13 == 0) {
            (**(code **)(plVar13[1] + 0x30))(plVar13);
          }
          ...
          if (lVar15 == 0) {
            FUN_23e915740(param_1,local_78,_DAT_23eedc280);
            uVar17 = 0x130;
            plVar9 = local_68;
            plVar13 = DAT_23ed6a4f8;
            goto joined_r0x00023e8a1b7a;
          ...
          if (iVar8 == 1) {
            ...
            PyDict_SetItem(plVar10,_DAT_23eedc1a0,plVar9);
            *plVar9 = *plVar9 + -1;
            if (*plVar9 == 0) {
              (**(code **)(plVar9[1] + 0x30))(plVar9);
            }
          ...
          if (plVar13 == (longlong *)0x0) goto LAB_23e8a1f00;
          plVar9 = (longlong *)FUN_23e8bc2f0(plVar2,_DAT_23eedc0f0);
          if (plVar9 == (longlong *)0x0) {
LAB_23e8a1e90:
            local_78._0_8_ = *(undefined8 *)(param_1 + 0x60);
            ...
            *plVar13 = *plVar13 + -1;
            ...
            plVar16 = (longlong *)FUN_23a38cc10(param_1,plVar9,_DAT_23eedc1b8);
            *plVar9 = *plVar9 + -1;
            if (*plVar9 == 0) {
              (**(code **)(plVar9[1] + 0x30))(plVar9);
            }
            if (plVar16 == (longlong *)0x0) goto LAB_23e8a1e90;
            *(undefined4 *)(plVar4 + 5) = 0x134;
            local_88 = pcVar11;
            plStack_80 = plVar16;
            plVar9 = (longlong *)FUN_23e94ed00(param_1,plVar13,&local_88);
            *plVar13 = *plVar13 + -1;
            if (*plVar13 == 0) {
              (**(code **)(plVar13[1] + 0x30))(plVar13);
            }
...
LAB_23e8a1f00:
              ...
              *plVar9 = *plVar9 + -1;
              ...
              if (plVar13 == (longlong *)0x0) goto LAB_23e8a1f00;
              local_a0 = (longlong *)(**(code **)(plVar13[1] + 0xe0))(plVar13);
              if ((local_a0 == (longlong *)0x0) &&
                 (local_a0 = (longlong *)FUN_23a3c1b70(param_1,local_78,0,2),
                 local_a0 == (longlong *)0x0)) {
                local_98 = (longlong *)0x0;
              }
              else {
                local_98 = (longlong *)(**(code **)(plVar13[1] + 0xe0))(plVar13);
                if (((local_98 != (longlong *)0x0) ||
                    (local_98 = (longlong *)FUN_23a3c1b70(param_1,local_78,1,2),
                    local_98 != (longlong *)0x0)) &&
                   (cVar7 = FUN_23a3884a0(param_1,local_78,plVar13,2), cVar7 != '\0')) {
                  *plVar13 = *plVar13 + -1;
                  if (*plVar13 == 0) {
                  ...
                  *local_98 = lVar15 + -1;
                  ...
                  iVar8 = FUN_23e97d0c0(local_a0,lVar15);
                  uVar18 = _DAT_23eedc288;
                  if (iVar8 == -1) {
                    local_78._0_8_ = *(undefined8 *)(param_1 + 0x60);
                    plVar9 = *(longlong **)(param_1 + 0x70);
                  ...
                  if (iVar8 == 1) {
                    plVar9 = (longlong *)_PyDict_NewPresized(2);
                    PyDict_SetItem(plVar9,uVar18,local_a0);
                    PyDict_SetItem(plVar9,_DAT_23eedc290,local_98);
                    PyDict_SetItem(plVar10,_DAT_23eedc1b8,plVar9);
                    *plVar9 = *plVar9 + -1;
                    if (*plVar9 == 0) {
                      (**(code **)(plVar9[1] + 0x30))(plVar9);
                    }
                  ...
                  plVar12 = (longlong *)FUN_23e8bc2f0(plVar2,_DAT_23eedc278);
                  if (plVar12 == (longlong *)0x0) goto LAB_23e8a2153;
                  plVar9 = (longlong *)FUN_23e8bc2f0(plVar2,_DAT_23eedc0f0);
                  if (plVar9 == (longlong *)0x0) {
LAB_23e8a2191:
                    local_78._0_8_ = *(undefined8 *)(param_1 + 0x60);
                    ...
                    *plVar12 = *plVar12 + -1;
                    ...
                    plVar13 = (longlong *)FUN_23a38cc10(param_1,plVar9,_DAT_23eedc1d0);
                    *plVar9 = *plVar9 + -1;
                    if (*plVar9 == 0) {
                      (**(code **)(plVar9[1] + 0x30))(plVar9);
                    }
                    if (plVar13 == (longlong *)0x0) goto LAB_23e8a2191;
                    *(undefined4 *)(plVar4 + 5) = 0x139;
                    local_88 = pcVar11;
                    plStack_80 = plVar13;
                    plVar9 = (longlong *)FUN_23e94ed00(param_1,plVar12,&local_88);
                    *plVar12 = *plVar12 + -1;
...
LAB_23e8a2153:
                      ...
                      *plVar9 = *plVar9 + -1;
                      ...
                      if (plVar13 == (longlong *)0x0) goto LAB_23e8a2153;
                      plVar14 = (longlong *)(**(code **)(plVar13[1] + 0xe0))(plVar13);
                      if ((plVar14 == (longlong *)0x0) &&
                         (plVar14 = (longlong *)FUN_23a3c1b70(param_1,local_78,0,2),
                         plVar14 == (longlong *)0x0)) {
                        plVar12 = (longlong *)0x0;
                      }
                      else {
                        plVar12 = (longlong *)(**(code **)(plVar13[1] + 0xe0))(plVar13);
                        if (((plVar12 != (longlong *)0x0) ||
                            (plVar12 = (longlong *)FUN_23a3c1b70(param_1,local_78,1,2),
                            plVar12 != (longlong *)0x0)) &&
                           (cVar7 = FUN_23a3884a0(param_1,local_78,plVar13,2), cVar7 != '\0')) {
                          *plVar13 = *plVar13 + -1;
                          if (*plVar13 == 0) {
                          ...
                          if (lVar15 == 0) {
                            ...
                            if (iVar8 != -1) {
                              if (iVar8 == 1) {
                                ...
                                PyDict_SetItem(plVar9,uVar18,plVar14);
                                PyDict_SetItem(plVar9,_DAT_23eedc290,plVar12);
                                PyDict_SetItem(plVar10,_DAT_23eedc1d0,plVar9);
                                *plVar9 = *plVar9 + -1;
                                if (*plVar9 == 0) {
              ...
              *plVar13 = *plVar13 + -1;
              ...
              local_78._8_8_ = 0;
              if ((local_a0 != (longlong *)0x0) &&
                 (lVar15 = *local_a0, *local_a0 = lVar15 + -1, lVar15 + -1 == 0)) {
                (**(code **)(local_a0[1] + 0x30))();
              }
              if ((local_98 != (longlong *)0x0) &&
                 (lVar15 = *local_98, *local_98 = lVar15 + -1, lVar15 + -1 == 0)) {
...
joined_r0x00023e8a1b7a:
  ...
  if (_DAT_23eede450 == plVar4) {
    *plVar4 = *plVar4 + -1;
    if (*plVar4 == 0) {
      (**(code **)(plVar4[1] + 0x30))(plVar4);
    }
    _DAT_23eede450 = (longlong *)0x0;
  }
  lVar15 = *(longlong *)(*(longlong *)(param_1 + 0x38) + 8);
  plVar9 = *(longlong **)(lVar15 + 0x28);
  plVar4 = (longlong *)plVar9[2];
  ...
  *plVar9 = *plVar9 + -1;
  ...
  local_78 = CONCAT88(uVar19,uVar18);
  *plVar2 = *plVar2 + -1;
  local_68 = plVar4;
  if (*plVar2 == 0) {
    (**(code **)(plVar2[1] + 0x30))(plVar2);
