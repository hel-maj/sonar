/* ===== 23e769800 workers.fishing.fishing_bot:FishingBot._do_store_backpack_routine ===== */
/* ghidra_name=FUN_23e769800 entry=23e769800 size=1738 */

longlong * FUN_23e769800(longlong param_1,longlong param_2,longlong *param_3)

{
  ...
  plVar10 = DAT_23eedada0;
  pauVar1 = *(undefined1 (**) [16])(param_2 + 0x90);
  if (*(int *)(param_2 + 0x78) == 1) {
    if (param_3 == (longlong *)0x0) goto LAB_23e769ac0;
    *param_3 = *param_3 + -1;
    if (*param_3 == 0) {
    ...
    *(undefined1 (*) [16])(pauVar1[1] + 8) = (undefined1  [16])0x0;
    if (plVar10 == (longlong *)0x0) {
LAB_23e76986f:
      plVar10 = (longlong *)FUN_23e91f3b0(param_1,DAT_23eedaff0,DAT_23eedaeb8,0x10);
      lVar11 = *plVar10;
      DAT_23eedada0 = plVar10;
    }
    else {
      lVar11 = *plVar10;
      if (1 < lVar11) {
...
LAB_23e769c40:
  ...
  plVar10 = DAT_23eedada0;
  if (*(longlong **)(param_2 + 0x50) == DAT_23eedada0) {
    *DAT_23eedada0 = *DAT_23eedada0 + -1;
    if (*plVar10 == 0) {
      (**(code **)(plVar10[1] + 0x30))();
    }
    DAT_23eedada0 = (longlong *)0x0;
  }
LAB_23e769c6b:
  plVar10 = *(longlong **)(param_2 + 0x68);
  if (plVar10 != (longlong *)0x0) {
