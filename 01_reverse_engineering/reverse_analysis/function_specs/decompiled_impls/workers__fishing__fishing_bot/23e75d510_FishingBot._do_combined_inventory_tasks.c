/* ===== 23e75d510 workers.fishing.fishing_bot:FishingBot._do_combined_inventory_tasks ===== */
/* ghidra_name=FUN_23e75d510 entry=23e75d510 size=1738 */

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

longlong * FUN_23e75d510(longlong param_1,longlong param_2,longlong *param_3)

{
  ...
  plVar10 = _DAT_23eedadc0;
  pauVar1 = *(undefined1 (**) [16])(param_2 + 0x90);
  if (*(int *)(param_2 + 0x78) == 1) {
    if (param_3 == (longlong *)0x0) goto LAB_23e75d7d0;
    *param_3 = *param_3 + -1;
    if (*param_3 == 0) {
    ...
    *(undefined1 (*) [16])(pauVar1[1] + 8) = (undefined1  [16])0x0;
    if (plVar10 == (longlong *)0x0) {
LAB_23e75d57f:
      plVar10 = (longlong *)FUN_23e91f3b0(param_1,_DAT_23eedaff8,DAT_23eedaeb8,0x10);
      lVar11 = *plVar10;
      _DAT_23eedadc0 = plVar10;
    }
    else {
      lVar11 = *plVar10;
      if (1 < lVar11) {
...
LAB_23e75d950:
  ...
  plVar10 = _DAT_23eedadc0;
  if (*(longlong **)(param_2 + 0x50) == _DAT_23eedadc0) {
    *_DAT_23eedadc0 = *_DAT_23eedadc0 + -1;
    if (*plVar10 == 0) {
      (**(code **)(plVar10[1] + 0x30))();
    }
    _DAT_23eedadc0 = (longlong *)0x0;
  }
LAB_23e75d97b:
  plVar10 = *(longlong **)(param_2 + 0x68);
  if (plVar10 != (longlong *)0x0) {
