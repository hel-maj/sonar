/* ===== 23e27a380 ui.fish_settings_dialog:c1183 ===== */
/* ghidra_name=FUN_23e27a380 entry=23e27a380 size=2022 */

/* WARNING: Type propagation algorithm not settling */

code * FUN_23e27a380(longlong param_1,undefined8 param_2,undefined8 *param_3)

{
  ...
  plVar10 = DAT_23eeb06f8;
  plVar1 = (longlong *)*param_3;
  if (DAT_23eeb06f8 == (longlong *)0x0) {
LAB_23e27a3ba:
    DAT_23eeb06f8 = (longlong *)FUN_23e91f3b0(param_1,DAT_23eeb0790,DAT_23eeb0770,0x10);
  }
  else {
    lVar2 = *DAT_23eeb06f8;
    if (1 < lVar2) {
      *DAT_23eeb06f8 = lVar2 + -1;
      goto LAB_23e27a3ba;
    }
    if (DAT_23eeb06f8[2] != 0) {
      *DAT_23eeb06f8 = lVar2 + -1;
      if (lVar2 + -1 == 0) {
  ...
  plVar7 = DAT_23eeb06f8;
  lVar2 = *(longlong *)(param_1 + 0x38);
  plVar10 = DAT_23eeb06f8 + 9;
  lVar3 = *(longlong *)(lVar2 + 8);
  DAT_23eeb06f8[0xf] = lVar3;
...
LAB_23e27a9d3:
    ...
    *(undefined8 *)(param_1 + 0x70) = 0;
    ...
    plVar11 = (longlong *)FUN_23e8bc2f0(plVar10,DAT_23eeaf610);
    *plVar10 = *plVar10 + -1;
    if (*plVar10 == 0) {
      (**(code **)(plVar10[1] + 0x30))(plVar10);
    }
    if (plVar11 != (longlong *)0x0) {
      ...
      *plVar11 = *plVar11 + -1;
      ...
      if (plVar10 == (longlong *)0x0) goto LAB_23e27a9d3;
...
LAB_23e27a81b:
            ...
            *(undefined1 (*) [16])(param_1 + 0x60) = (undefined1  [16])0x0;
            *(undefined8 *)(param_1 + 0x70) = 0;
            if (plVar11 != (longlong *)0x0) goto LAB_23e27a664;
            plVar11 = (longlong *)0x0;
            uVar16 = 0xf5;
            goto LAB_23e27a670;
          }
          plVar13 = (longlong *)(*pcVar14)(plVar12);
          if (plVar13 == (longlong *)0x0) goto LAB_23e27a81b;
          if (plVar11 == (longlong *)0x0) {
            *plVar13 = *plVar13 + 1;
          }
          else {
          ...
          *(undefined4 *)(plVar7 + 5) = 0xf6;
          plVar10 = (longlong *)
                    FUN_23e915840(param_1,plVar13,DAT_23eeaf618,*(undefined8 *)(lVar2 + 0x18));
          plVar11 = plVar13;
          if (plVar10 == (longlong *)0x0) {
            local_50 = *(longlong *)(param_1 + 0x60);
            uVar15 = *(undefined8 *)(param_1 + 0x68);
          ...
          *plVar10 = *plVar10 + -1;
          ...
          if (((*(int *)(*(longlong *)(lVar2 + 0x28) + 0x160) != 0) || (*(int *)(lVar2 + 0x78) != 0)
                    ...
                    (local_50 = *(longlong *)(param_1 + 0x60), local_50 != 0)))) goto LAB_23e27a646;
          if (*(int *)(lVar2 + 0x68) == 0) {
...
joined_r0x00023e27a920:
  ...
  if (DAT_23eeb06f8 == plVar7) {
    *plVar7 = *plVar7 + -1;
    if (*plVar7 == 0) {
      (**(code **)(plVar7[1] + 0x30))(plVar7);
    }
    DAT_23eeb06f8 = (longlong *)0x0;
  }
  lVar2 = *(longlong *)(*(longlong *)(param_1 + 0x38) + 8);
  plVar10 = *(longlong **)(lVar2 + 0x28);
  plVar7 = (longlong *)plVar10[2];
  ...
  *plVar1 = *plVar1 + -1;
  ...
  FUN_23a33aa70(param_1,local_50,uVar15,plVar12);
  return (code *)0x0;
}
