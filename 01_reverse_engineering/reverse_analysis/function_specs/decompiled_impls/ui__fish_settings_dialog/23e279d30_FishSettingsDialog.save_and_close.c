/* ===== 23e279d30 ui.fish_settings_dialog:c1155 ===== */
/* ghidra_name=FUN_23e279d30 entry=23e279d30 size=1534 */

code * FUN_23e279d30(longlong param_1,undefined8 param_2,undefined8 *param_3)

{
  ...
  plVar7 = DAT_23eeb0710;
  plVar1 = (longlong *)*param_3;
  if (DAT_23eeb0710 != (longlong *)0x0) {
    lVar2 = *DAT_23eeb0710;
    if (lVar2 < 2) {
      if (DAT_23eeb0710[2] == 0) goto LAB_23e279d95;
      *DAT_23eeb0710 = lVar2 + -1;
      if (lVar2 + -1 == 0) {
  ...
  DAT_23eeb0710 = (longlong *)FUN_23e91f3b0(param_1,DAT_23eeb07a0,DAT_23eeb0770,0x18);
LAB_23e279d95:
  plVar4 = DAT_23eeb0710;
  lVar2 = *(longlong *)(param_1 + 0x38);
  plVar7 = DAT_23eeb0710 + 9;
  lVar3 = *(longlong *)(lVar2 + 8);
  DAT_23eeb0710[0xf] = lVar3;
  ...
  *(undefined4 *)(plVar4 + 8) = 0;
  ...
  if (plVar7 == (longlong *)0x0) {
    ...
    *(undefined4 *)(plVar4 + 5) = 0xb6;
    plVar8 = (longlong *)FUN_23e91bfe0(param_1,plVar7,DAT_23eeaf568);
    *plVar7 = *plVar7 + -1;
    if (*plVar7 == 0) {
      (**(code **)(plVar7[1] + 0x30))(plVar7);
    }
    if (plVar8 == (longlong *)0x0) {
      ...
      if (plVar7 == (longlong *)0x0) {
        ...
        *(undefined4 *)(plVar4 + 5) = 0xb7;
        local_68 = uVar13;
        plStack_60 = plVar10;
        plVar9 = (longlong *)FUN_23e94ed00(param_1,plVar7,&local_68);
        *plVar7 = *plVar7 + -1;
        if (*plVar7 == 0) {
          (**(code **)(plVar7[1] + 0x30))(plVar7);
        }
        *plVar10 = *plVar10 + -1;
        ...
        if (plVar9 == (longlong *)0x0) {
          ...
          *(undefined4 *)(plVar4 + 5) = 0xb8;
          plVar7 = (longlong *)FUN_23e915840(param_1,plVar1,DAT_23eeaf590,plVar9);
          if (plVar7 != (longlong *)0x0) {
            *plVar7 = *plVar7 + -1;
            if (*plVar7 == 0) {
              (**(code **)(plVar7[1] + 0x30))(plVar7);
  ...
  *(undefined1 (*) [16])(param_1 + 0x60) = (undefined1  [16])0x0;
  ...
  if (DAT_23eeb0710 == plVar4) {
    *plVar4 = *plVar4 + -1;
    if (*plVar4 == 0) {
      (**(code **)(plVar4[1] + 0x30))(plVar4);
    }
    DAT_23eeb0710 = (longlong *)0x0;
  }
  lVar2 = *(longlong *)(*(longlong *)(param_1 + 0x38) + 8);
  plVar7 = *(longlong **)(lVar2 + 0x28);
  plVar4 = (longlong *)plVar7[2];
