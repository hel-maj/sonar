/* ===== 23e275120 ui.fish_settings_dialog:c922 ===== */
/* ghidra_name=FUN_23e275120 entry=23e275120 size=1006 */

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

longlong FUN_23e275120(longlong param_1,undefined8 param_2,undefined8 *param_3)

{
  ...
  plVar7 = _DAT_23eeb0758;
  plVar1 = (longlong *)*param_3;
  if (_DAT_23eeb0758 != (longlong *)0x0) {
    lVar8 = *_DAT_23eeb0758;
    if (lVar8 < 2) {
      if (_DAT_23eeb0758[2] == 0) goto LAB_23e27517e;
      *_DAT_23eeb0758 = lVar8 + -1;
      if (lVar8 + -1 == 0) {
  ...
  _DAT_23eeb0758 = (longlong *)FUN_23e91f3b0(param_1,_DAT_23eeb07b0,DAT_23eeb0770,8);
LAB_23e27517e:
  plVar3 = _DAT_23eeb0758;
  lVar8 = *(longlong *)(param_1 + 0x38);
  plVar7 = _DAT_23eeb0758 + 9;
  lVar2 = *(longlong *)(lVar8 + 8);
  _DAT_23eeb0758[0xf] = lVar2;
  ...
  *(undefined4 *)(plVar3 + 8) = 0;
  ...
  if (plVar7 != (longlong *)0x0) {
    *(undefined4 *)(plVar3 + 5) = 0x50;
    lVar8 = FUN_23e91bfe0(param_1,plVar7,_DAT_23eeaf408);
    *plVar7 = *plVar7 + -1;
    if (*plVar7 == 0) {
      (**(code **)(plVar7[1] + 0x30))(plVar7);
    }
  ...
  *(undefined1 (*) [16])(param_1 + 0x60) = (undefined1  [16])0x0;
  ...
  if (_DAT_23eeb0758 == plVar3) {
    *plVar3 = *plVar3 + -1;
    if (*plVar3 == 0) {
      (**(code **)(plVar3[1] + 0x30))(plVar3);
    }
    _DAT_23eeb0758 = (longlong *)0x0;
  }
