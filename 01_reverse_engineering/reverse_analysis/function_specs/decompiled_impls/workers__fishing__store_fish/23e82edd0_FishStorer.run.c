/* ===== 23e82edd0 workers.fishing.store_fish:422 ===== */
/* ghidra_name=FUN_23e82edd0 entry=23e82edd0 size=1556 */

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

code * FUN_23e82edd0(longlong param_1)

{
  ...
  plVar7 = _DAT_23eede5e8;
  if (_DAT_23eede5e8 == (longlong *)0x0) {
LAB_23e82ee07:
    _DAT_23eede5e8 = (longlong *)FUN_23e91f3b0(param_1,_DAT_23eede5e0,DAT_23eede708,8);
  }
  else {
    lVar9 = *_DAT_23eede5e8;
    if (1 < lVar9) {
      *_DAT_23eede5e8 = lVar9 + -1;
      goto LAB_23e82ee07;
    }
    if (_DAT_23eede5e8[2] != 0) {
      *_DAT_23eede5e8 = lVar9 + -1;
      if (lVar9 + -1 == 0) {
  ...
  plVar2 = _DAT_23eede5e8;
  lVar9 = *(longlong *)(param_1 + 0x38);
  plVar7 = _DAT_23eede5e8 + 9;
  lVar1 = *(longlong *)(lVar9 + 8);
  _DAT_23eede5e8[0xf] = lVar1;
  ...
  *(undefined4 *)(plVar2 + 8) = 0;
  ...
  if ((plVar7 == (longlong *)0x0) || (lVar9 = *plVar7, lVar9 == 0)) {
    ...
    *(undefined4 *)(plVar2 + 5) = 0x1a8;
    plVar7 = (longlong *)FUN_23e94bb80(param_1,lVar9,_DAT_23eedcdd0);
    if (plVar7 == (longlong *)0x0) {
    ...
    *plVar7 = *plVar7 + -1;
    ...
    lVar9 = *(longlong *)(DAT_23eedc7f0 + 0x20);
    if (*(char *)(lVar9 + 10) == '\0') {
      plVar7 = (longlong *)FUN_23a37a020(DAT_23eedc7f0,_DAT_23eedcdd8);
      if (plVar7 == (longlong *)0x0) goto LAB_23e82f059;
      lVar9 = *plVar7;
LAB_23e82f2e8:
      if (lVar9 == 0) goto LAB_23e82f059;
    }
    else {
      iVar6 = *(int *)(lVar9 + 0xc);
      if (*(int *)(lVar9 + 0xc) == 0) {
        *(int *)(lVar9 + 0xc) = DAT_23ec1555c;
        iVar6 = DAT_23ec1555c;
        DAT_23ec1555c = DAT_23ec1555c + 1;
      }
      if (_DAT_23ec15534 != iVar6) {
        _DAT_23ec15534 = iVar6;
        _DAT_23eede5d8 = FUN_23e8cbd60(lVar9,_DAT_23eedcdd8,*(undefined8 *)(_DAT_23eedcdd8 + 0x18));
      }
      if (-1 < _DAT_23eede5d8) {
        lVar1 = lVar9 + 0x20 + (1L << (*(byte *)(lVar9 + 9) & 0x3f));
        if (*(longlong *)(lVar1 + 8 + _DAT_23eede5d8 * 0x10) != 0) goto LAB_23e82ef56;
        _DAT_23eede5d8 = FUN_23e8cbd60(lVar9,_DAT_23eedcdd8,*(undefined8 *)(_DAT_23eedcdd8 + 0x18));
        if (-1 < _DAT_23eede5d8) {
          lVar9 = *(longlong *)(lVar1 + 8 + _DAT_23eede5d8 * 0x10);
          goto LAB_23e82f2e8;
        }
      }
LAB_23e82f059:
      plVar7 = (longlong *)FUN_23a37a020(DAT_23ed6ccc0,_DAT_23eedcdd8);
      if ((plVar7 == (longlong *)0x0) || (*plVar7 == 0)) {
        uVar12 = 0x1ae;
        unaff_RSI = (longlong *)0x0;
        FUN_23e915740(param_1,&uStack_68,_DAT_23eedcdd8);
        plVar7 = plStack_58;
        uVar10 = uStack_68;
        uVar11 = uStack_60;
        goto LAB_23e82f0a5;
...
LAB_23e82ef56:
    *(undefined4 *)(plVar2 + 5) = 0x1ae;
    unaff_RSI = (longlong *)FUN_23e91a870(param_1);
    if (unaff_RSI != (longlong *)0x0) {
      *(undefined4 *)(plVar2 + 5) = 0x1af;
      plVar7 = (longlong *)FUN_23e91bfe0(param_1,unaff_RSI,_DAT_23eedcde0);
      if (plVar7 != (longlong *)0x0) {
        *plVar7 = *plVar7 + -1;
        if (*plVar7 == 0) {
          (**(code **)(plVar7[1] + 0x30))(plVar7);
...
LAB_23e82f0a5:
  ...
  if (_DAT_23eede5e8 == plVar2) {
    *plVar2 = *plVar2 + -1;
    if (*plVar2 == 0) {
      (**(code **)(plVar2[1] + 0x30))(plVar2);
    }
    _DAT_23eede5e8 = (longlong *)0x0;
  }
  lVar9 = *(longlong *)(*(longlong *)(param_1 + 0x38) + 8);
  plVar7 = *(longlong **)(lVar9 + 0x28);
  plVar2 = (longlong *)plVar7[2];
