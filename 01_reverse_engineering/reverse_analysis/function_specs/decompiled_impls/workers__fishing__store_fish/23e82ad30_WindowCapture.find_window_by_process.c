/* ===== 23e82ad30 workers.fishing.store_fish:63 ===== */
/* ghidra_name=FUN_23e82ad30 entry=23e82ad30 size=3216 */

longlong * FUN_23e82ad30(longlong param_1,undefined8 param_2,undefined8 *param_3)

{
  ...
  plVar11 = DAT_23eede6c8;
  plVar1 = (longlong *)*param_3;
  local_68 = (longlong *)0x0;
  local_78._0_8_ = 0;
  local_78._8_8_ = 0;
  if (DAT_23eede6c8 == (longlong *)0x0) {
LAB_23e82ad84:
    DAT_23eede6c8 = (longlong *)FUN_23e91f3b0(param_1,DAT_23eede6c0,DAT_23eede708,0x28);
  }
  else {
    lVar12 = *DAT_23eede6c8;
    if (1 < lVar12) {
      *DAT_23eede6c8 = lVar12 + -1;
      goto LAB_23e82ad84;
    }
    if (DAT_23eede6c8[2] != 0) {
      *DAT_23eede6c8 = lVar12 + -1;
      if (lVar12 + -1 == 0) {
  ...
  plVar3 = DAT_23eede6c8;
  lVar12 = *(longlong *)(param_1 + 0x38);
  plVar11 = DAT_23eede6c8 + 9;
  lVar2 = *(longlong *)(lVar12 + 8);
  DAT_23eede6c8[0xf] = lVar2;
...
LAB_23e82b620:
  ...
  if (iVar9 == 0) {
LAB_23e82ae47:
    plVar17 = DAT_23eedc880;
    plVar16 = (longlong *)0x0;
    plVar14 = (longlong *)0x0;
    plVar13 = (longlong *)0x0;
    plVar11 = (longlong *)0x0;
    *DAT_23eedc880 = *DAT_23eedc880 + 1;
LAB_23e82ae5c:
  ...
  if (lVar12 == 0) {
    FUN_23e915740(param_1,local_78,DAT_23eedc820);
  }
  else {
    plVar13 = (longlong *)FUN_23e8bc2f0(lVar12,DAT_23eedc878);
    ...
    plVar11 = (longlong *)FUN_23e8bc2f0(plVar1,DAT_23eedc808);
    if (plVar11 != (longlong *)0x0) {
      ...
      *plVar14 = *plVar14 + -1;
      ...
      if (uVar10 == 0xffffffff) goto LAB_23e82b620;
      if ((uVar10 & 1) == 0) goto LAB_23e82ae47;
      lVar12 = FUN_23e8dbf70();
      if (lVar12 == 0) {
        FUN_23e915740(param_1,local_78,DAT_23eedc820);
        plVar17 = local_68;
        ...
        plVar11 = (longlong *)FUN_23e8bc2f0(lVar12,DAT_23eedc888);
        if (plVar11 != (longlong *)0x0) {
          plVar13 = (longlong *)FUN_23e8bc2f0(plVar1,DAT_23eedc808);
          if (plVar13 == (longlong *)0x0) {
            local_78._0_8_ = *(undefined8 *)(param_1 + 0x60);
            local_78._8_8_ = *(undefined8 *)(param_1 + 0x68);
            local_68 = *(longlong **)(param_1 + 0x70);
...
LAB_23e82b3b2:
  ...
  if (DAT_23eede6c8 == plVar3) {
    *plVar3 = *plVar3 + -1;
    if (*plVar3 == 0) {
      (**(code **)(plVar3[1] + 0x30))(plVar3);
    }
    DAT_23eede6c8 = (longlong *)0x0;
  }
  lVar12 = *(longlong *)(*(longlong *)(param_1 + 0x38) + 8);
  plVar3 = *(longlong **)(lVar12 + 0x28);
