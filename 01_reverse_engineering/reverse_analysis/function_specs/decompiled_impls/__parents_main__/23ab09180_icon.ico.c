/* ===== 23ab09180 __parents_main__:51 ===== */
/* ghidra_name=FUN_23ab09180 entry=23ab09180 size=7023 */

/* WARNING: Type propagation algorithm not settling */

code * FUN_23ab09180(longlong param_1)

{
  ...
  plVar7 = DAT_23ed90b30;
  if (DAT_23ed90b30 == (longlong *)0x0) {
LAB_23ab091c2:
    DAT_23ed90b30 = (longlong *)FUN_23e91f3b0(param_1,DAT_23ed90b28,DAT_23ed90b40,0x20);
  }
  else {
    lVar9 = *DAT_23ed90b30;
    if (1 < lVar9) {
      *DAT_23ed90b30 = lVar9 + -1;
      goto LAB_23ab091c2;
    }
    if (DAT_23ed90b30[2] != 0) {
      *DAT_23ed90b30 = lVar9 + -1;
      if (lVar9 + -1 == 0) {
  ...
  plVar3 = DAT_23ed90b30;
  lVar9 = *(longlong *)(param_1 + 0x38);
  plVar7 = DAT_23ed90b30 + 9;
  lVar14 = *(longlong *)(lVar9 + 8);
  DAT_23ed90b30[0xf] = lVar14;
...
LAB_23ab09d0d:
      ...
      if (iVar5 == -1) {
        ...
        *(undefined1 (*) [16])(param_1 + 0x60) = (undefined1  [16])0x0;
        pcVar22 = _PyRuntime_exref;
        if (pcVar20 != (code *)0x0) {
          if (*(longlong **)(pcVar20 + 0x18) == plVar3) goto LAB_23ab09ca4;
          plVar8 = (longlong *)0x0;
          plVar7 = (longlong *)0x0;
          uVar21 = 0x39;
LAB_23ab09a40:
...
LAB_23ab099cd:
        ...
        plVar7 = (longlong *)FUN_23e8bc2f0(DAT_23ed6a210,DAT_23ed8f358);
        if (plVar7 == (longlong *)0x0) {
          local_d0 = *(longlong **)(param_1 + 0x60);
          pcVar20 = *(code **)(param_1 + 0x70);
          *(undefined8 *)(param_1 + 0x70) = 0;
...
LAB_23ab0a3c0:
        ...
        iVar5 = PySequence_Contains(plVar7,DAT_23ed8f370);
        if (iVar5 == -1) {
LAB_23ab0a3d0:
          local_d0 = *(longlong **)(param_1 + 0x60);
          pcVar20 = *(code **)(param_1 + 0x70);
          *(undefined8 *)(param_1 + 0x70) = 0;
          pcVar18 = *(code **)(param_1 + 0x68);
          *(undefined1 (*) [16])(param_1 + 0x60) = (undefined1  [16])0x0;
joined_r0x00023ab09e32:
          if (pcVar20 != (code *)0x0) {
            plVar8 = *(longlong **)(pcVar20 + 0x18);
joined_r0x00023ab0a3b2:
            if (plVar8 != plVar3) {
              plVar8 = (longlong *)0x0;
              uVar21 = 0x41;
              pcVar22 = _PyRuntime_exref;
...
LAB_23ab0933a:
            ...
            if (plVar8 == (longlong *)0x0) {
              ...
              *(undefined1 (*) [16])(param_1 + 0x60) = (undefined1  [16])0x0;
              ...
              if (pcVar20 != (code *)0x0) {
                pcVar16 = pcVar20;
                pcVar19 = pcVar18;
                if (plVar3 == *(longlong **)(pcVar20 + 0x18)) goto LAB_23ab09ad0;
                uVar21 = 0x42;
                goto LAB_23ab09a40;
              }
              iVar5 = 0x42;
            ...
            plVar10 = (longlong *)FUN_23e8bc2f0(lVar9,DAT_23ed8f390);
            plVar11 = DAT_23ed8f398;
            ...
            *plVar11 = *plVar11 + 1;
            ...
            if (DAT_23ed6a4c0 == (longlong *)0x0) {
              ...
              if (plVar11 == (longlong *)0x0) goto LAB_23ab0acd4;
              *plVar11 = *plVar11 + 1;
            ...
            *plVar12 = *plVar12 + -1;
            ...
            lVar9 = *(longlong *)(DAT_23ed8f338 + 0x20);
            if (*(char *)(lVar9 + 10) == '\0') {
              plVar11 = (longlong *)FUN_23a37a020(DAT_23ed8f338,DAT_23ed8f3a0);
              if (plVar11 == (longlong *)0x0) goto LAB_23ab0aa50;
              lVar14 = *plVar11;
LAB_23ab0aa47:
              if (lVar14 == 0) goto LAB_23ab0aa50;
            }
            else {
              iVar5 = *(int *)(lVar9 + 0xc);
              if (*(int *)(lVar9 + 0xc) == 0) {
                *(int *)(lVar9 + 0xc) = DAT_23ec10790;
                iVar5 = DAT_23ec10790;
                DAT_23ec10790 = DAT_23ec10790 + 1;
              }
              if (DAT_23ec10794 != iVar5) {
                DAT_23ec10794 = iVar5;
                DAT_23ed90b20 =
                     FUN_23e8cbd60(lVar9,DAT_23ed8f3a0,*(undefined8 *)(DAT_23ed8f3a0 + 0x18));
              }
              if (-1 < DAT_23ed90b20) {
                lVar1 = lVar9 + 0x20 + (1L << (*(byte *)(lVar9 + 9) & 0x3f));
                lVar14 = *(longlong *)(lVar1 + 8 + DAT_23ed90b20 * 0x10);
                if (lVar14 != 0) goto LAB_23ab095a0;
                DAT_23ed90b20 =
                     FUN_23e8cbd60(lVar9,DAT_23ed8f3a0,*(undefined8 *)(DAT_23ed8f3a0 + 0x18));
                if (-1 < DAT_23ed90b20) {
                  lVar14 = *(longlong *)(lVar1 + 8 + DAT_23ed90b20 * 0x10);
...
LAB_23ab0aa50:
              plVar11 = (longlong *)FUN_23a37a020(DAT_23ed6ccc0,DAT_23ed8f3a0);
              if ((plVar11 == (longlong *)0x0) || (lVar14 = *plVar11, lVar14 == 0)) {
                FUN_23e915740(param_1,pplVar23,DAT_23ed8f3a0);
                local_d0._0_4_ = 0x48;
                pcVar20 = local_68;
                plVar11 = local_78;
                pcVar18 = pcStack_70;
...
LAB_23ab095a0:
            plVar11 = (longlong *)FUN_23e8bc2f0(lVar14,DAT_23ed8f3a8);
            if (plVar11 != (longlong *)0x0) {
              lVar9 = *(longlong *)(param_1 + 0x10);
              ...
              *plVar12 = *plVar12 + -1;
              ...
              if (plVar13 != (longlong *)0x0) {
                *plVar13 = *plVar13 + -1;
                ...
                lVar9 = DAT_23ed8f3b8;
                if (lVar14 == 0) goto LAB_23ab0ace7;
...
LAB_23ab09ea0:
            do {
              ...
              if (pcVar20 == (code *)0x0) {
                ...
                *plVar3 = *plVar3 + 1;
                lVar9 = *(longlong *)(pcVar22 + 0x1f8);
                *(undefined4 *)(pcVar18 + 0x24) = local_d0._0_4_;
                lVar9 = *(longlong *)(lVar9 + 0x10);
              ...
              if ((longlong **)local_88[0] == pplVar23) {
                pcVar20 = (code *)0x0;
              }
              else {
                pcVar20 = local_88[0];
...
LAB_23ab0ab12:
                  ...
                  if (iVar5 != 0) goto LAB_23ab09d28;
                }
                else {
                  local_d0 = *(longlong **)(pcVar19 + 8);
                  ...
                  if (pcVar20 != (code *)0x0) {
                    ...
                    *(longlong *)pcVar19 = *(longlong *)pcVar19 + -1;
                    if (*(longlong *)pcVar19 == 0) {
                      (*(code *)local_d0[6])(pcVar19);
                      iVar5 = 0;
                      goto LAB_23ab0a6ca;
                    }
                    pcVar16 = pcVar20;
                    if (plVar3 != *(longlong **)(pcVar20 + 0x18)) goto LAB_23ab0a6dd;
                    goto LAB_23ab09ad0;
                  }
                  *(longlong **)(param_1 + 0x138) = plVar10;
                  *(longlong *)pcVar19 = *(longlong *)pcVar19 + -1;
              ...
              *plVar11 = *plVar11 + 1;
              ...
              plVar13 = (longlong *)FUN_23e8bc2f0(lVar9,DAT_23ed8f3c0);
              plVar12 = DAT_23ed8f3c8;
              if (plVar13 == (longlong *)0x0) {
                local_d0 = *(longlong **)(param_1 + 0x60);
                *(undefined1 (*) [16])(param_1 + 0x60) = (undefined1  [16])0x0;
                pcVar20 = *(code **)(param_1 + 0x70);
              ...
              *plVar12 = *plVar12 + 1;
              ...
              pcVar20 = DAT_23ed6cd28;
              if (plVar17 != (longlong *)0x0) goto LAB_23ab0a196;
              pcVar18 = pcVar22;
              plVar17 = (longlong *)PyDict_GetItemString(DAT_23ed6ccc0,"format");
              if (plVar17 != (longlong *)0x0) goto code_r0x00023ab0a9ba;
LAB_23ab0acd4:
              PyErr_PrintEx(0);
              Py_Exit(1);
LAB_23ab0ace7:
              FUN_23e915740(param_1,pplVar23,DAT_23ed8f388);
              local_d0._0_4_ = 0x4a;
              pcVar22 = pcVar18;
              pcVar20 = local_68;
              plVar11 = local_78;
            ...
            *plVar8 = *plVar8 + -1;
            ...
            if (plVar11 == (longlong *)0x0) {
              ...
              *(undefined1 (*) [16])(param_1 + 0x60) = (undefined1  [16])0x0;
              ...
              plVar8 = (longlong *)FUN_23e8bc2f0(plVar11,DAT_23ed8f378);
              *plVar11 = *plVar11 + -1;
              if (*plVar11 == 0) {
                (**(code **)(plVar11[1] + 0x30))(plVar11);
              }
              if (plVar8 == (longlong *)0x0) goto LAB_23ab0a418;
              *(undefined4 *)(plVar3 + 5) = 0x41;
              plVar11 = (longlong *)FUN_23e94bb80(param_1,plVar8,DAT_23ed8f380);
              *plVar8 = *plVar8 + -1;
              if (*plVar8 == 0) {
                (**(code **)(plVar8[1] + 0x30))(plVar8);
              }
              if (plVar11 == (longlong *)0x0) goto LAB_23ab0a3d0;
              ...
              *plVar11 = lVar9;
              if (lVar9 == 0) {
                (**(code **)(plVar11[1] + 0x30))(plVar11);
                goto joined_r0x00023ab09e32;
              }
            }
            if (pcVar20 != (code *)0x0) {
              plVar8 = *(longlong **)(pcVar20 + 0x18);
              goto joined_r0x00023ab0a3b2;
            }
          }
        }
        plVar8 = (longlong *)0x0;
...
LAB_23ab09ad0:
  ...
  if (DAT_23ed90b30 == plVar3) {
    *plVar3 = *plVar3 + -1;
    if (*plVar3 == 0) {
      (**(code **)(plVar3[1] + 0x30))(plVar3);
    }
    DAT_23ed90b30 = (longlong *)0x0;
  }
  lVar9 = *(longlong *)(*(longlong *)(param_1 + 0x38) + 8);
  plVar3 = *(longlong **)(lVar9 + 0x28);
  *(undefined8 *)(*(longlong *)(param_1 + 0x38) + 8) = *(undefined8 *)(lVar9 + 0x30);
  ...
  *plVar3 = *plVar3 + -1;
  ...
  FUN_23a33aa70(param_1,local_d0,pcVar19,pcVar16);
  return (code *)0x0;
code_r0x00023ab0a9ba:
  *plVar17 = *plVar17 + 1;
  DAT_23ed6a4c0 = plVar17;
LAB_23ab0a196:
  pcStack_a0 = pcVar20;
  local_a8 = plVar11;
  lVar9 = FUN_23e94ed00(param_1,plVar17,&local_a8);
  if (lVar9 == 0) {
    local_d0 = *(longlong **)(param_1 + 0x60);
    pcVar18 = *(code **)(param_1 + 0x68);
    pcVar20 = *(code **)(param_1 + 0x70);
...
joined_r0x00023ab0a895:
      pcVar16 = pcVar20;
      pcVar19 = pcVar18;
      if (plVar3 == plVar11) goto LAB_23ab09ad0;
      uVar21 = 0x4c;
      goto LAB_23ab09a40;
    }
  }
...
LAB_23ab0a6ca:
        pcVar16 = pcVar20;
        pcVar19 = pcVar18;
        if (*(longlong **)(pcVar20 + 0x18) == plVar3) goto LAB_23ab09ad0;
        if (iVar5 == 0) {
LAB_23ab0a6dd:
