/* ===== 23e7abf50 workers.fishing.hooking:75 ===== */
/* ghidra_name=FUN_23e7abf50 entry=23e7abf50 size=3216 */

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

longlong * FUN_23e7abf50(longlong param_1,undefined8 param_2,undefined8 *param_3)

{
  ...
  plVar11 = _DAT_23eedab38;
  plVar1 = (longlong *)*param_3;
  plStack_68 = (longlong *)0x0;
  auStack_78._0_8_ = 0;
  auStack_78._8_8_ = 0;
  if (_DAT_23eedab38 == (longlong *)0x0) {
LAB_23e7abfa4:
    _DAT_23eedab38 = (longlong *)FUN_23e91f3b0(param_1,_DAT_23eedab30,DAT_23eedab78,0x28);
  }
  else {
    lVar12 = *_DAT_23eedab38;
    if (1 < lVar12) {
      *_DAT_23eedab38 = lVar12 + -1;
      goto LAB_23e7abfa4;
    }
    if (_DAT_23eedab38[2] != 0) {
      *_DAT_23eedab38 = lVar12 + -1;
      if (lVar12 + -1 == 0) {
  ...
  plVar3 = _DAT_23eedab38;
  lVar12 = *(longlong *)(param_1 + 0x38);
  plVar11 = _DAT_23eedab38 + 9;
  lVar2 = *(longlong *)(lVar12 + 8);
  _DAT_23eedab38[0xf] = lVar2;
...
LAB_23e7ac840:
  ...
  if (iVar9 == 0) {
LAB_23e7ac067:
    plVar17 = _DAT_23eed79e0;
    plVar16 = (longlong *)0x0;
    plVar14 = (longlong *)0x0;
    plVar13 = (longlong *)0x0;
    plVar11 = (longlong *)0x0;
    *_DAT_23eed79e0 = *_DAT_23eed79e0 + 1;
LAB_23e7ac07c:
  ...
  lVar12 = FUN_23e8df2f0();
  if (lVar12 == 0) {
    FUN_23e915740(param_1,auStack_78,DAT_23eed7980);
  }
  else {
    plVar13 = (longlong *)FUN_23e8bc2f0(lVar12,_DAT_23eed79d8);
    ...
    plVar11 = (longlong *)FUN_23e8bc2f0(plVar1,DAT_23eed7968);
    if (plVar11 != (longlong *)0x0) {
      ...
      *plVar14 = *plVar14 + -1;
      ...
      if (uVar10 == 0xffffffff) goto LAB_23e7ac840;
      if ((uVar10 & 1) == 0) goto LAB_23e7ac067;
      lVar12 = FUN_23e8df2f0();
      if (lVar12 == 0) {
        FUN_23e915740(param_1,auStack_78,DAT_23eed7980);
        plVar17 = plStack_68;
        ...
        plVar11 = (longlong *)FUN_23e8bc2f0(lVar12,_DAT_23eed79e8);
        if (plVar11 != (longlong *)0x0) {
          plVar13 = (longlong *)FUN_23e8bc2f0(plVar1,DAT_23eed7968);
          if (plVar13 == (longlong *)0x0) {
            auStack_78._0_8_ = *(undefined8 *)(param_1 + 0x60);
            auStack_78._8_8_ = *(undefined8 *)(param_1 + 0x68);
            plStack_68 = *(longlong **)(param_1 + 0x70);
...
LAB_23e7ac5d2:
  ...
  if (_DAT_23eedab38 == plVar3) {
    *plVar3 = *plVar3 + -1;
    if (*plVar3 == 0) {
      (**(code **)(plVar3[1] + 0x30))(plVar3);
    }
    _DAT_23eedab38 = (longlong *)0x0;
  }
  lVar12 = *(longlong *)(*(longlong *)(param_1 + 0x38) + 8);
  plVar3 = *(longlong **)(lVar12 + 0x28);
