/* ===== 23e7a9c40 workers.fishing.hooking:45 ===== */
/* ghidra_name=FUN_23e7a9c40 entry=23e7a9c40 size=1186 */

code * FUN_23e7a9c40(longlong param_1,undefined8 param_2,undefined8 *param_3)

{
  ...
  plVar9 = DAT_23eedab80;
  plVar1 = (longlong *)*param_3;
  plVar2 = (longlong *)param_3[1];
  if (DAT_23eedab80 == (longlong *)0x0) {
LAB_23e7a9c7e:
    DAT_23eedab80 = (longlong *)FUN_23e91f3b0(param_1,DAT_23eedab70,DAT_23eedab78,0x10);
  }
  else {
    lVar3 = *DAT_23eedab80;
    if (1 < lVar3) {
      *DAT_23eedab80 = lVar3 + -1;
      goto LAB_23e7a9c7e;
    }
    if (DAT_23eedab80[2] != 0) {
      *DAT_23eedab80 = lVar3 + -1;
      if (lVar3 + -1 == 0) {
  ...
  plVar5 = DAT_23eedab80;
  lVar3 = *(longlong *)(param_1 + 0x38);
  plVar9 = DAT_23eedab80 + 9;
  lVar4 = *(longlong *)(lVar3 + 8);
  DAT_23eedab80[0xf] = lVar4;
  ...
  if (plVar9 != (longlong *)0x0) {
    ...
    *plVar9 = *plVar9 + -1;
    ...
    if (plVar10 != (longlong *)0x0) {
      cVar8 = FUN_23e8d9ac0(plVar1,DAT_23eed7960,plVar10);
      *plVar10 = *plVar10 + -1;
      if (*plVar10 == 0) {
      ...
      if (cVar8 != '\0') {
        cVar8 = FUN_23e8d9ac0(plVar1,DAT_23eed7968,_Py_NoneStruct_exref);
        if (cVar8 != '\0') {
...
LAB_23e7a9ea1:
  ...
  *(undefined1 (*) [16])(param_1 + 0x60) = (undefined1  [16])0x0;
  ...
  if (DAT_23eedab80 == plVar5) {
    *plVar5 = *plVar5 + -1;
    if (*plVar5 == 0) {
      (**(code **)(plVar5[1] + 0x30))(plVar5);
    }
    DAT_23eedab80 = (longlong *)0x0;
  }
  lVar3 = *(longlong *)(*(longlong *)(param_1 + 0x38) + 8);
  plVar9 = *(longlong **)(lVar3 + 0x28);
  plVar5 = (longlong *)plVar9[2];
