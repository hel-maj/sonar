/* ===== 23e2aa200 ui.garbage_settings_dialog:c940 ===== */
/* ghidra_name=FUN_23e2aa200 entry=23e2aa200 size=1098 */

code * FUN_23e2aa200(longlong param_1,undefined8 param_2,undefined8 *param_3)

{
  ...
  plVar10 = DAT_23eeb0408;
  plVar1 = (longlong *)*param_3;
  plVar2 = (longlong *)param_3[1];
  if (DAT_23eeb0408 != (longlong *)0x0) {
    lVar3 = *DAT_23eeb0408;
    if (lVar3 < 2) {
      if (DAT_23eeb0408[2] == 0) goto LAB_23e2aa264;
      *DAT_23eeb0408 = lVar3 + -1;
      if (lVar3 + -1 == 0) {
  ...
  DAT_23eeb0408 = (longlong *)FUN_23e91f3b0(param_1,DAT_23eeb0440,DAT_23eeb0428,0x10);
LAB_23e2aa264:
  plVar5 = DAT_23eeb0408;
  lVar3 = *(longlong *)(param_1 + 0x38);
  plVar10 = DAT_23eeb0408 + 9;
  lVar4 = *(longlong *)(lVar3 + 8);
  DAT_23eeb0408[0xf] = lVar4;
  ...
  *(undefined4 *)(plVar5 + 8) = 0;
  ...
  if (plVar10 != (longlong *)0x0) {
    *(undefined4 *)(plVar5 + 5) = 0x54;
    plVar11 = (longlong *)FUN_23e915840(param_1,plVar10,DAT_23eeae3e8,plVar2);
    *plVar10 = *plVar10 + -1;
    if (*plVar10 == 0) {
      (**(code **)(plVar10[1] + 0x30))(plVar10);
    }
  ...
  *(undefined1 (*) [16])(param_1 + 0x60) = (undefined1  [16])0x0;
  ...
  if (DAT_23eeb0408 == plVar5) {
    *plVar5 = *plVar5 + -1;
    if (*plVar5 == 0) {
      (**(code **)(plVar5[1] + 0x30))(plVar5);
    }
    DAT_23eeb0408 = (longlong *)0x0;
  }
  lVar3 = *(longlong *)(*(longlong *)(param_1 + 0x38) + 8);
  plVar10 = *(longlong **)(lVar3 + 0x28);
  plVar5 = (longlong *)plVar10[2];
