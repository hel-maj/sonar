/* ===== 23c0332d0 config_manager:72 ===== */
/* ghidra_name=FUN_23c0332d0 entry=23c0332d0 size=3928 */

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

longlong * FUN_23c0332d0(longlong param_1,undefined8 param_2,longlong *param_3)

{
  ...
  plVar6 = _DAT_23ee0b640;
  param_3 = (longlong *)*param_3;
  plStack_68 = (longlong *)0x0;
  auStack_78 = (undefined1  [16])0x0;
  if (_DAT_23ee0b640 == (longlong *)0x0) {
LAB_23c03332f:
    _DAT_23ee0b640 = (longlong *)FUN_23e91f3b0(param_1,_DAT_23ee0b638,DAT_23ee0b670,0x18);
  }
  else {
    lVar13 = *_DAT_23ee0b640;
    if (1 < lVar13) {
      *_DAT_23ee0b640 = lVar13 + -1;
      goto LAB_23c03332f;
    }
    if (_DAT_23ee0b640[2] != 0) {
      *_DAT_23ee0b640 = lVar13 + -1;
      if (lVar13 + -1 == 0) {
  ...
  plVar3 = _DAT_23ee0b640;
  lVar13 = *(longlong *)(param_1 + 0x38);
  plVar6 = _DAT_23ee0b640 + 9;
  lVar16 = *(longlong *)(lVar13 + 8);
  _DAT_23ee0b640[0xf] = lVar16;
...
LAB_23c033dd0:
    ...
    *plVar7 = *plVar7 + -1;
    ...
    if (plVar8 == (longlong *)0x0) goto LAB_23c033dd0;
    plVar7 = (longlong *)FUN_23ebf7180(plVar8);
    *plVar8 = *plVar8 + -1;
    if (*plVar8 == 0) {
      (**(code **)(plVar8[1] + 0x30))(plVar8);
    }
    if (plVar7 == (longlong *)0x0) goto LAB_23c033dd0;
...
LAB_23c033aad:
      ...
      if (plVar9 == (longlong *)0x0) goto LAB_23c033aad;
      if ((plVar17 != (longlong *)0x0) && (*plVar17 = *plVar17 + -1, *plVar17 == 0)) {
        (**(code **)(plVar17[1] + 0x30))(plVar17);
      }
...
LAB_23c033d95:
        *plVar10 = lVar16 + -1;
        ...
        lVar13 = auStack_78._0_8_;
        uVar20 = auStack_78._8_8_;
        if (lVar16 + -1 == 0) goto LAB_23c033cac;
        goto LAB_23c033cee;
      }
      cVar5 = FUN_23a3884a0(param_1,auStack_78,plVar10,2);
      lVar16 = *plVar10;
      if (cVar5 == '\0') goto LAB_23c033d95;
      *plVar10 = lVar16 + -1;
      if (lVar16 + -1 == 0) {
        (**(code **)(plVar10[1] + 0x30))(plVar10);
      }
      ...
      *plVar12 = lVar13;
      ...
      if ((((*(int *)(*(longlong *)(lVar16 + 0x28) + 0x160) != 0) || (*(int *)(lVar16 + 0x78) != 0))
         ...
         (lVar13 = *(longlong *)(param_1 + 0x60), lVar13 != 0)) goto LAB_23c033a6c;
...
LAB_23c033dfb:
  ...
  if (_DAT_23ee0b640 == plVar3) {
    *plVar3 = *plVar3 + -1;
    if (*plVar3 == 0) {
      (**(code **)(plVar3[1] + 0x30))(plVar3);
    }
    _DAT_23ee0b640 = (longlong *)0x0;
  }
  lVar13 = *(longlong *)(*(longlong *)(param_1 + 0x38) + 8);
  plVar3 = *(longlong **)(lVar13 + 0x28);
  plVar7 = (longlong *)plVar3[2];
