/* ===== 23e6f2f80 workers.fishing.casting_a_fishin:56 ===== */
/* ghidra_name=FUN_23e6f2f80 entry=23e6f2f80 size=3216 */

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

longlong * FUN_23e6f2f80(longlong param_1,undefined8 param_2,undefined8 *param_3)

{
  ...
  plVar11 = _DAT_23eedb228;
  plVar1 = (longlong *)*param_3;
  local_68 = (longlong *)0x0;
  local_78._0_8_ = 0;
  local_78._8_8_ = 0;
  if (_DAT_23eedb228 == (longlong *)0x0) {
LAB_23e6f2fd4:
    _DAT_23eedb228 = (longlong *)FUN_23e91f3b0(param_1,_DAT_23eedb220,DAT_23eedb268,0x28);
  }
  else {
    lVar12 = *_DAT_23eedb228;
    if (1 < lVar12) {
      *_DAT_23eedb228 = lVar12 + -1;
      goto LAB_23e6f2fd4;
    }
    if (_DAT_23eedb228[2] != 0) {
      *_DAT_23eedb228 = lVar12 + -1;
      if (lVar12 + -1 == 0) {
  ...
  plVar3 = _DAT_23eedb228;
  lVar12 = *(longlong *)(param_1 + 0x38);
  plVar11 = _DAT_23eedb228 + 9;
  lVar2 = *(longlong *)(lVar12 + 8);
  _DAT_23eedb228[0xf] = lVar2;
...
LAB_23e6f3870:
  ...
  if (iVar9 == 0) {
LAB_23e6f3097:
    plVar17 = _DAT_23eeda3a0;
    plVar16 = (longlong *)0x0;
    plVar14 = (longlong *)0x0;
    plVar13 = (longlong *)0x0;
    plVar11 = (longlong *)0x0;
    *_DAT_23eeda3a0 = *_DAT_23eeda3a0 + 1;
LAB_23e6f30ac:
  ...
  lVar12 = FUN_23e8e1ef0();
  if (lVar12 == 0) {
    FUN_23e915740(param_1,local_78,_DAT_23eeda340);
  }
  else {
    plVar13 = (longlong *)FUN_23e8bc2f0(lVar12,_DAT_23eeda398);
    ...
    plVar11 = (longlong *)FUN_23e8bc2f0(plVar1,DAT_23eeda328);
    if (plVar11 != (longlong *)0x0) {
      ...
      *plVar14 = *plVar14 + -1;
      ...
      if (uVar10 == 0xffffffff) goto LAB_23e6f3870;
      if ((uVar10 & 1) == 0) goto LAB_23e6f3097;
      lVar12 = FUN_23e8e1ef0();
      if (lVar12 == 0) {
        FUN_23e915740(param_1,local_78,_DAT_23eeda340);
        plVar17 = local_68;
        ...
        plVar11 = (longlong *)FUN_23e8bc2f0(lVar12,_DAT_23eeda3a8);
        if (plVar11 != (longlong *)0x0) {
          plVar13 = (longlong *)FUN_23e8bc2f0(plVar1,DAT_23eeda328);
          if (plVar13 == (longlong *)0x0) {
            local_78._0_8_ = *(undefined8 *)(param_1 + 0x60);
            local_78._8_8_ = *(undefined8 *)(param_1 + 0x68);
            local_68 = *(longlong **)(param_1 + 0x70);
...
LAB_23e6f3602:
  ...
  if (_DAT_23eedb228 == plVar3) {
    *plVar3 = *plVar3 + -1;
    if (*plVar3 == 0) {
      (**(code **)(plVar3[1] + 0x30))(plVar3);
    }
    _DAT_23eedb228 = (longlong *)0x0;
  }
  lVar12 = *(longlong *)(*(longlong *)(param_1 + 0x38) + 8);
  plVar3 = *(longlong **)(lVar12 + 0x28);
