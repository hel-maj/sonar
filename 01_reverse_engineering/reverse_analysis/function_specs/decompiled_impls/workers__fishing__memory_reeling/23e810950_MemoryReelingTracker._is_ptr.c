/* ===== 23e810950 workers.fishing.memory_reeling:MemoryReelingTracker._is_ptr ===== */
/* ghidra_name=FUN_23e810950 entry=23e810950 size=3284 */

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

longlong * FUN_23e810950(longlong param_1,longlong param_2,longlong *param_3)

{
  ...
  plVar8 = _DAT_23eede868;
  pauVar2 = *(undefined1 (**) [16])(param_2 + 0x90);
  if (*(int *)(param_2 + 0x78) == 1) {
    if (param_3 == (longlong *)0x0) goto LAB_23e811295;
    *param_3 = *param_3 + -1;
    if (*param_3 == 0) {
...
LAB_23e811299:
    ...
    *(undefined1 (*) [16])(pauVar2[4] + 8) = (undefined1  [16])0x0;
    if (plVar8 == (longlong *)0x0) {
LAB_23e8109cb:
      plVar8 = (longlong *)FUN_23e91f3b0(param_1,_DAT_23eedea28,DAT_23eedd0f8,0x20);
      lVar9 = *plVar8;
      _DAT_23eede868 = plVar8;
    }
    else {
      lVar9 = *plVar8;
      if (1 < lVar9) {
...
LAB_23e811000:
        ...
        plVar8 = *(longlong **)(pauVar2[2] + 8);
        if (plVar8 != (longlong *)0x0) goto LAB_23e811000;
      }
      plVar8 = *(longlong **)pauVar2[3];
...
LAB_23e811020:
        ...
        (**(code **)(plVar15[1] + 0x30))(plVar15);
        plVar8 = *(longlong **)pauVar2[3];
        if (plVar8 != (longlong *)0x0) goto LAB_23e811020;
      }
      lVar9 = *(longlong *)(param_2 + 0xa8);
      *(undefined8 *)pauVar2[3] = 0;
      plVar8 = *(longlong **)(lVar9 + 0x10);
      if (plVar8 == (longlong *)0x0) {
        if (((*(byte *)(_DAT_23eedd540 + 0x20) & 0x40) == 0) ||
           (lVar9 = _DAT_23eedd540 + 0x30, (*(byte *)(_DAT_23eedd540 + 0x20) & 0x20) == 0)) {
          lVar9 = *(longlong *)(_DAT_23eedd540 + 0x38);
        }
...
LAB_23e810c6f:
            ...
            if (plVar8 != (longlong *)0x0) goto LAB_23e810c6f;
          }
        }
        *(undefined8 *)(pauVar2[4] + 8) = *(undefined8 *)(param_1 + 0x60);
        *(undefined8 *)pauVar2[5] = *(undefined8 *)(param_1 + 0x68);
...
LAB_23e811250:
  ...
  plVar8 = _DAT_23eede868;
  if (*(longlong **)(param_2 + 0x50) == _DAT_23eede868) {
    *_DAT_23eede868 = *_DAT_23eede868 + -1;
    if (*plVar8 == 0) {
      (**(code **)(plVar8[1] + 0x30))();
    }
    _DAT_23eede868 = (longlong *)0x0;
  }
LAB_23e810f0f:
  plVar8 = *(longlong **)(param_2 + 0x68);
  if (plVar8 != (longlong *)0x0) {
