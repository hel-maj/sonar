/* ===== 23e7c3620 workers.fishing.meal_system:43 ===== */
/* ghidra_name=FUN_23e7c3620 entry=23e7c3620 size=1186 */

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

code * FUN_23e7c3620(longlong param_1,undefined8 param_2,undefined8 *param_3)

{
  ...
  plVar9 = _DAT_23eedaa50;
  plVar1 = (longlong *)*param_3;
  plVar2 = (longlong *)param_3[1];
  if (_DAT_23eedaa50 == (longlong *)0x0) {
LAB_23e7c365e:
    _DAT_23eedaa50 = (longlong *)FUN_23e91f3b0(param_1,_DAT_23eed7938,DAT_23eed7940,0x10);
  }
  else {
    lVar3 = *_DAT_23eedaa50;
    if (1 < lVar3) {
      *_DAT_23eedaa50 = lVar3 + -1;
      goto LAB_23e7c365e;
    }
    if (_DAT_23eedaa50[2] != 0) {
      *_DAT_23eedaa50 = lVar3 + -1;
      if (lVar3 + -1 == 0) {
  ...
  plVar5 = _DAT_23eedaa50;
  lVar3 = *(longlong *)(param_1 + 0x38);
  plVar9 = _DAT_23eedaa50 + 9;
  lVar4 = *(longlong *)(lVar3 + 8);
  _DAT_23eedaa50[0xf] = lVar4;
  ...
  if (plVar9 != (longlong *)0x0) {
    ...
    *plVar9 = *plVar9 + -1;
    ...
    if (plVar10 != (longlong *)0x0) {
      cVar8 = FUN_23e8d9ac0(plVar1,_DAT_23eed70a0,plVar10);
      *plVar10 = *plVar10 + -1;
      if (*plVar10 == 0) {
      ...
      if (cVar8 != '\0') {
        cVar8 = FUN_23e8d9ac0(plVar1,_DAT_23eed70a8,_Py_NoneStruct_exref);
        if (cVar8 != '\0') {
...
LAB_23e7c3881:
  ...
  *(undefined1 (*) [16])(param_1 + 0x60) = (undefined1  [16])0x0;
  ...
  if (_DAT_23eedaa50 == plVar5) {
    *plVar5 = *plVar5 + -1;
    if (*plVar5 == 0) {
      (**(code **)(plVar5[1] + 0x30))(plVar5);
    }
    _DAT_23eedaa50 = (longlong *)0x0;
  }
  lVar3 = *(longlong *)(*(longlong *)(param_1 + 0x38) + 8);
  plVar9 = *(longlong **)(lVar3 + 0x28);
  plVar5 = (longlong *)plVar9[2];
