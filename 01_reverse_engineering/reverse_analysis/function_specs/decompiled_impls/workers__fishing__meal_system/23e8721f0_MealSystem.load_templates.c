/* ===== 23e8721f0 workers.fishing.meal_system:292 ===== */
/* ghidra_name=FUN_23e8721f0 entry=23e8721f0 size=2342 */

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

longlong * FUN_23e8721f0(longlong param_1,undefined8 param_2,undefined8 *param_3)

{
  ...
  plVar9 = _DAT_23eedec78;
  plVar1 = (longlong *)*param_3;
  plVar2 = (longlong *)param_3[1];
  local_88 = (longlong *)0x0;
  local_98 = 0;
  uStack_90 = 0;
  if (_DAT_23eedec78 == (longlong *)0x0) {
LAB_23e87224b:
    _DAT_23eedec78 = (longlong *)FUN_23e91f3b0(param_1,_DAT_23eedec70,DAT_23eed7940,0x28);
  }
  else {
    lVar3 = *_DAT_23eedec78;
    if (1 < lVar3) {
      *_DAT_23eedec78 = lVar3 + -1;
      goto LAB_23e87224b;
    }
    if (_DAT_23eedec78[2] != 0) {
      *_DAT_23eedec78 = lVar3 + -1;
      if (lVar3 + -1 == 0) {
  ...
  plVar5 = _DAT_23eedec78;
  lVar3 = *(longlong *)(param_1 + 0x38);
  plVar9 = _DAT_23eedec78 + 9;
  lVar4 = *(longlong *)(lVar3 + 8);
  _DAT_23eedec78[0xf] = lVar4;
    ...
    if (plVar10 != (longlong *)0x0) {
      ...
      *plVar10 = *plVar10 + -1;
      ...
      if (plVar11 != (longlong *)0x0) {
        plVar10 = (longlong *)FUN_23e8bc2f0(plVar1,uRam000000023eed72c8);
        if (plVar10 == (longlong *)0x0) {
...
LAB_23e8726ae:
  ...
  if (_DAT_23eedec78 == plVar5) {
    *plVar5 = *plVar5 + -1;
    if (*plVar5 == 0) {
      (**(code **)(plVar5[1] + 0x30))(plVar5);
    }
    _DAT_23eedec78 = (longlong *)0x0;
  }
  lVar3 = *(longlong *)(*(longlong *)(param_1 + 0x38) + 8);
