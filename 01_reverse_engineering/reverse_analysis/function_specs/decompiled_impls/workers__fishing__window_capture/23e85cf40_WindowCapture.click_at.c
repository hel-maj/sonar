/* ===== 23e85cf40 workers.fishing.window_capture:137 ===== */
/* ghidra_name=FUN_23e85cf40 entry=23e85cf40 size=1291 */

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

code * FUN_23e85cf40(longlong param_1,undefined8 param_2,undefined8 *param_3)

{
  ...
  plVar9 = _DAT_23eede270;
  plVar1 = (longlong *)*param_3;
  plVar2 = (longlong *)param_3[1];
  if (_DAT_23eede270 == (longlong *)0x0) {
LAB_23e85cf7e:
    _DAT_23eede270 = (longlong *)FUN_23e91f3b0(param_1,_DAT_23eede268,DAT_23eede308,0x10);
  }
  else {
    lVar7 = *_DAT_23eede270;
    if (1 < lVar7) {
      *_DAT_23eede270 = lVar7 + -1;
      goto LAB_23e85cf7e;
    }
    if (_DAT_23eede270[2] != 0) {
      *_DAT_23eede270 = lVar7 + -1;
      if (lVar7 + -1 == 0) {
  ...
  plVar4 = _DAT_23eede270;
  lVar7 = *(longlong *)(param_1 + 0x38);
  plVar9 = _DAT_23eede270 + 9;
  lVar3 = *(longlong *)(lVar7 + 8);
  _DAT_23eede270[0xf] = lVar3;
  ...
  *(undefined4 *)(plVar4 + 8) = 0;
  ...
  plVar8 = (longlong *)FUN_23e8bc2f0(lVar7,_DAT_23eedb998);
...
LAB_23e85d1bc:
  ...
  if (_DAT_23eede270 == plVar4) {
    *plVar4 = *plVar4 + -1;
    if (*plVar4 == 0) {
      (**(code **)(plVar4[1] + 0x30))(plVar4);
    }
    _DAT_23eede270 = (longlong *)0x0;
  }
  lVar7 = *(longlong *)(*(longlong *)(param_1 + 0x38) + 8);
  plVar9 = *(longlong **)(lVar7 + 0x28);
  plVar4 = (longlong *)plVar9[2];
