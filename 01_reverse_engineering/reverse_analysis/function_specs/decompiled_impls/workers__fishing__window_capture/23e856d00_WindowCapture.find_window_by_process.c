/* ===== 23e856d00 workers.fishing.window_capture:26 ===== */
/* ghidra_name=FUN_23e856d00 entry=23e856d00 size=3953 */

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

code * FUN_23e856d00(longlong param_1,undefined8 param_2,longlong *param_3)

{
  ...
  *(longlong **)(lVar10 + 8) = plVar17 + -2;
  if (plVar9 != (longlong *)0x0) {
    lVar10 = *plVar9;
    if (lVar10 < 2) {
      if (plVar9[2] == 0) goto LAB_23e856efb;
      *plVar9 = lVar10 + -1;
      if (lVar10 + -1 == 0) {
  ...
  plVar9 = (longlong *)FUN_23e91f3b0(param_1,_DAT_23eede2f0,DAT_23eede308,0x28);
  _DAT_23eede2f8 = plVar9;
LAB_23e856efb:
  ...
  *(undefined4 *)(plVar9 + 8) = 0;
  ...
  if (lVar10 == 0) {
    ...
    *(undefined4 *)(plVar9 + 5) = 0x28;
    plStack_88 = plVar8;
    plStack_80 = plVar17;
    plVar11 = (longlong *)FUN_23e954670(param_1,lVar10,_DAT_23eedb7c0,&plStack_88);
    if (plVar11 == (longlong *)0x0) {
          ...
          if (plVar13 == (longlong *)0x0) {
            ...
            if (cVar6 == '\0') {
              ...
              *(undefined1 (*) [16])(param_1 + 0x60) = (undefined1  [16])0x0;
              ...
              aplStack_68[0] = (longlong *)0x0;
              auStack_78 = (undefined1  [16])0x0;
              if (plStack_a8 == (longlong *)0x0) goto LAB_23e8573fa;
              uVar20 = 0x2d;
              goto LAB_23e8573d0;
            }
            lVar10 = *(longlong *)(*(longlong *)(param_1 + 0x38) + 8);
...
LAB_23e857738:
          ...
          if ((plVar15 == (longlong *)0x0) &&
             (plVar15 = (longlong *)FUN_23a3c1b70(param_1,auStack_78,0,2),
             plVar15 == (longlong *)0x0)) {
            plVar16 = (longlong *)0x0;
            lVar10 = *plVar14;
LAB_23e85769c:
            plVar13 = aplStack_68[0];
            pcVar18 = (code *)auStack_78._0_8_;
          ...
          if ((plVar16 == (longlong *)0x0) &&
             (plVar16 = (longlong *)FUN_23a3c1b70(param_1,auStack_78,1,2),
             plVar16 == (longlong *)0x0)) {
            lVar10 = *plVar14;
            goto LAB_23e85769c;
          }
          cVar6 = FUN_23a3884a0(param_1,auStack_78,plVar14,2);
          lVar10 = *plVar14;
          if (cVar6 == '\0') goto LAB_23e85769c;
          *plVar14 = lVar10 + -1;
          if (lVar10 + -1 == 0) {
            (**(code **)(plVar14[1] + 0x30))(plVar14);
          }
          ...
          *plVar16 = lVar10;
          ...
          if (iVar7 != 0) {
            if (plVar19[2] == 0) {
              ...
              *(longlong *)auStack_78._0_8_ = *(longlong *)auStack_78._0_8_ + 1;
              ...
              cVar6 = FUN_23e8d9ac0(plVar19[2],DAT_23eedb788,plVar15);
          ...
          if ((((*(int *)(*(longlong *)(lVar10 + 0x28) + 0x160) != 0) ||
             ...
             (pcVar18 = *(code **)(param_1 + 0x60), pcVar18 != (code *)0x0)) goto LAB_23e85738a;
...
LAB_23e8573fa:
        ...
        *plVar12 = lVar10 + -1;
        ...
        auStack_78._0_8_ = pcVar18;
        aplStack_68[0] = plVar13;
      }
    }
  }
  plVar16 = aplStack_68[0];
  ...
  else if ((longlong *)aplStack_68[0][3] != plVar9) {
    if (DAT_23ed6a4f8 == (longlong *)0x0) {
      plVar15 = (longlong *)FUN_23a33a530(PyTraceBack_Type_exref);
    }
    else {
  ...
  aplStack_68[0] = plVar16;
  FUN_23e8bba40(plVar9,"coooo",plVar19,plVar8,plVar17,plVar11,plVar22);
  if (_DAT_23eede2f8 == plVar9) {
    *plVar9 = *plVar9 + -1;
    if (*plVar9 == 0) {
      (**(code **)(plVar9[1] + 0x30))(plVar9);
    }
    _DAT_23eede2f8 = (longlong *)0x0;
  }
  lVar10 = *(longlong *)(*(longlong *)(param_1 + 0x38) + 8);
  plVar9 = *(longlong **)(lVar10 + 0x28);
  plVar15 = (longlong *)plVar9[2];
