/* ===== 23e71acf0 workers.fishing.fish_recognition:286 ===== */
/* ghidra_name=FUN_23e71acf0 entry=23e71acf0 size=1556 */

code * FUN_23e71acf0(longlong param_1)

{
  ...
  plVar7 = DAT_23eedb048;
  if (DAT_23eedb048 == (longlong *)0x0) {
LAB_23e71ad27:
    DAT_23eedb048 = (longlong *)FUN_23e91f3b0(param_1,DAT_23eedb040,DAT_23eedb148,8);
  }
  else {
    lVar9 = *DAT_23eedb048;
    if (1 < lVar9) {
      *DAT_23eedb048 = lVar9 + -1;
      goto LAB_23e71ad27;
    }
    if (DAT_23eedb048[2] != 0) {
      *DAT_23eedb048 = lVar9 + -1;
      if (lVar9 + -1 == 0) {
  ...
  plVar2 = DAT_23eedb048;
  lVar9 = *(longlong *)(param_1 + 0x38);
  plVar7 = DAT_23eedb048 + 9;
  lVar1 = *(longlong *)(lVar9 + 8);
  DAT_23eedb048[0xf] = lVar1;
  ...
  *(undefined4 *)(plVar2 + 8) = 0;
  ...
  if ((plVar7 == (longlong *)0x0) || (lVar9 = *plVar7, lVar9 == 0)) {
    ...
    *(undefined4 *)(plVar2 + 5) = 0x120;
    plVar7 = (longlong *)FUN_23e94bb80(param_1,lVar9,DAT_23eeda148);
    if (plVar7 == (longlong *)0x0) {
    ...
    *plVar7 = *plVar7 + -1;
    ...
    lVar9 = *(longlong *)(DAT_23eed9ce8 + 0x20);
    if (*(char *)(lVar9 + 10) == '\0') {
      plVar7 = (longlong *)FUN_23a37a020(DAT_23eed9ce8,DAT_23eeda150);
      if (plVar7 == (longlong *)0x0) goto LAB_23e71af79;
      lVar9 = *plVar7;
LAB_23e71b208:
      if (lVar9 == 0) goto LAB_23e71af79;
    }
    else {
      iVar6 = *(int *)(lVar9 + 0xc);
      if (*(int *)(lVar9 + 0xc) == 0) {
        *(int *)(lVar9 + 0xc) = DAT_23ec15484;
        iVar6 = DAT_23ec15484;
        DAT_23ec15484 = DAT_23ec15484 + 1;
      }
      if (DAT_23ec15464 != iVar6) {
        DAT_23ec15464 = iVar6;
        DAT_23eedb038 = FUN_23e8cbd60(lVar9,DAT_23eeda150,*(undefined8 *)(DAT_23eeda150 + 0x18));
      }
      if (-1 < DAT_23eedb038) {
        lVar1 = lVar9 + 0x20 + (1L << (*(byte *)(lVar9 + 9) & 0x3f));
        if (*(longlong *)(lVar1 + 8 + DAT_23eedb038 * 0x10) != 0) goto LAB_23e71ae76;
        DAT_23eedb038 = FUN_23e8cbd60(lVar9,DAT_23eeda150,*(undefined8 *)(DAT_23eeda150 + 0x18));
        if (-1 < DAT_23eedb038) {
          lVar9 = *(longlong *)(lVar1 + 8 + DAT_23eedb038 * 0x10);
          goto LAB_23e71b208;
        }
      }
LAB_23e71af79:
      plVar7 = (longlong *)FUN_23a37a020(DAT_23ed6ccc0,DAT_23eeda150);
      if ((plVar7 == (longlong *)0x0) || (*plVar7 == 0)) {
        uVar12 = 0x126;
        unaff_RSI = (longlong *)0x0;
        FUN_23e915740(param_1,&local_68,DAT_23eeda150);
        plVar7 = local_58;
        uVar10 = local_68;
        uVar11 = local_60;
        goto LAB_23e71afc5;
    ...
    *(undefined4 *)(plVar2 + 5) = 0x126;
    ...
    if (unaff_RSI != (longlong *)0x0) {
      *(undefined4 *)(plVar2 + 5) = 0x127;
      plVar7 = (longlong *)FUN_23e91bfe0(param_1,unaff_RSI,DAT_23eeda158);
      if (plVar7 != (longlong *)0x0) {
        *plVar7 = *plVar7 + -1;
        if (*plVar7 == 0) {
          (**(code **)(plVar7[1] + 0x30))(plVar7);
...
LAB_23e71afc5:
  ...
  if (DAT_23eedb048 == plVar2) {
    *plVar2 = *plVar2 + -1;
    if (*plVar2 == 0) {
      (**(code **)(plVar2[1] + 0x30))(plVar2);
    }
    DAT_23eedb048 = (longlong *)0x0;
  }
  lVar9 = *(longlong *)(*(longlong *)(param_1 + 0x38) + 8);
  plVar7 = *(longlong **)(lVar9 + 0x28);
  plVar2 = (longlong *)plVar7[2];
