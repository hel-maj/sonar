/* ===== 23e122ff0 telegram.handlers.notifications_:75 ===== */
/* ghidra_name=FUN_23e122ff0 entry=23e122ff0 size=2717 */

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

code * FUN_23e122ff0(longlong param_1,undefined8 param_2,longlong *param_3)

{
  ...
  *(longlong **)(lVar7 + 8) = plVar12 + -2;
  uVar6 = FUN_23e8d7870(param_1,_DAT_23eea8c80);
  uVar16 = DAT_23eeaafd0;
  *plVar13 = *plVar13 + 1;
  local_68 = plVar13;
  lVar7 = FUN_23e93e1e0(FUN_23e123ae0,_DAT_23eea8c88,_DAT_23eea8c90,_DAT_23eeaaf88,0,uVar6,uVar16,0,
                        &local_68,1);
  plVar8 = _DAT_23eeaafb0;
  plVar12[2] = lVar7;
  if (plVar8 == (longlong *)0x0) {
LAB_23e12318c:
    plVar8 = (longlong *)FUN_23e91f3b0(param_1,_DAT_23eeaafa8,DAT_23eeaafd0,0x20);
    _DAT_23eeaafb0 = plVar8;
  }
  else {
    lVar7 = *plVar8;
    if (1 < lVar7) {
...
LAB_23e123640:
    ...
    *(undefined1 (*) [16])(param_1 + 0x60) = (undefined1  [16])0x0;
    ...
    if (*(char *)(lVar7 + 10) == '\0') {
      plVar10 = (longlong *)FUN_23a37a020(DAT_23eea8b50,_DAT_23eea8ca0);
      if (plVar10 == (longlong *)0x0) goto LAB_23e1235b9;
      lVar14 = *plVar10;
LAB_23e1239f8:
      if (lVar14 == 0) goto LAB_23e1235b9;
LAB_23e1232a3:
      plVar10 = (longlong *)FUN_23e8bc2f0(lVar14,_DAT_23eea8ca8);
      if (plVar10 != (longlong *)0x0) {
        plVar11 = (longlong *)FUN_23e8bc2f0(plVar10,_DAT_23eea8cb0);
        *plVar10 = *plVar10 + -1;
        if (*plVar10 == 0) {
          (**(code **)(plVar10[1] + 0x30))(plVar10);
        }
        if (plVar11 != (longlong *)0x0) {
          *(undefined4 *)(plVar8 + 5) = 0x53;
          plVar10 = (longlong *)FUN_23e94bb80(param_1,plVar11,_DAT_23eea8cb8);
          *plVar11 = *plVar11 + -1;
          if (*plVar11 == 0) {
          ...
          if (plVar10 != (longlong *)0x0) {
            ...
            *plVar10 = *plVar10 + -1;
            ...
            uVar16 = _DAT_23eea8cc0;
            if (plVar11 == (longlong *)0x0) goto LAB_23e123640;
            lVar7 = *(longlong *)(DAT_23eea8b50 + 0x20);
            if (*(char *)(lVar7 + 10) == '\0') {
              plVar9 = (longlong *)FUN_23a37a020(DAT_23eea8b50,_DAT_23eea8cc8);
              if (plVar9 == (longlong *)0x0) goto LAB_23e123931;
              lVar14 = *plVar9;
LAB_23e123a78:
              if (lVar14 == 0) goto LAB_23e123931;
            }
            else {
              iVar5 = *(int *)(lVar7 + 0xc);
              if (*(int *)(lVar7 + 0xc) == 0) {
              ...
              if (_DAT_23ec14c5c != iVar5) {
                _DAT_23ec14c5c = iVar5;
                _DAT_23eeaaf98 =
                     FUN_23e8cbd60(lVar7,_DAT_23eea8cc8,*(undefined8 *)(_DAT_23eea8cc8 + 0x18));
              }
              if (-1 < _DAT_23eeaaf98) {
                lVar1 = lVar7 + 0x20 + (1L << (*(byte *)(lVar7 + 9) & 0x3f));
                lVar14 = *(longlong *)(lVar1 + 8 + _DAT_23eeaaf98 * 0x10);
                if (lVar14 != 0) goto LAB_23e1233ef;
                _DAT_23eeaaf98 =
                     FUN_23e8cbd60(lVar7,_DAT_23eea8cc8,*(undefined8 *)(_DAT_23eea8cc8 + 0x18));
                if (-1 < _DAT_23eeaaf98) {
                  lVar14 = *(longlong *)(lVar1 + 8 + _DAT_23eeaaf98 * 0x10);
...
LAB_23e123931:
              plVar9 = (longlong *)FUN_23a37a020(DAT_23ed6ccc0,_DAT_23eea8cc8);
              if ((plVar9 == (longlong *)0x0) || (lVar14 = *plVar9, lVar14 == 0)) {
                FUN_23e915740(param_1,&local_68,_DAT_23eea8cc8);
                local_70 = local_68;
                *plVar11 = *plVar11 + -1;
                if (*plVar11 == 0) {
                  (**(code **)(plVar11[1] + 0x30))(plVar11);
...
LAB_23e1233ef:
            ...
            PyDict_SetItem(uVar6,_DAT_23eea8cd0,_Py_NoneStruct_exref);
            uVar16 = _DAT_23eea8cd8;
            *plVar12 = *plVar12 + 1;
            local_68 = plVar12;
            plVar9 = (longlong *)
                     FUN_23e93e1e0(FUN_23e124110,_DAT_23eea8ce0,_DAT_23eea8ce8,_DAT_23eeaafa0,0,
                                   uVar6,DAT_23eeaafd0,uVar16,&local_68,1);
            *(undefined4 *)(plVar8 + 5) = 0x53;
      ...
      *(undefined1 (*) [16])(param_1 + 0x60) = (undefined1  [16])0x0;
      ...
      if (_DAT_23ec14c58 != iVar5) {
        _DAT_23ec14c58 = iVar5;
        _DAT_23eeaaf90 = FUN_23e8cbd60(lVar7,_DAT_23eea8ca0,*(undefined8 *)(_DAT_23eea8ca0 + 0x18));
      }
      if (-1 < _DAT_23eeaaf90) {
        lVar1 = lVar7 + 0x20 + (1L << (*(byte *)(lVar7 + 9) & 0x3f));
        lVar14 = *(longlong *)(lVar1 + 8 + _DAT_23eeaaf90 * 0x10);
        if (lVar14 != 0) goto LAB_23e1232a3;
        _DAT_23eeaaf90 = FUN_23e8cbd60(lVar7,_DAT_23eea8ca0,*(undefined8 *)(_DAT_23eea8ca0 + 0x18));
        if (-1 < _DAT_23eeaaf90) {
          lVar14 = *(longlong *)(lVar1 + 8 + _DAT_23eeaaf90 * 0x10);
          goto LAB_23e1239f8;
...
LAB_23e1235b9:
      plVar10 = (longlong *)FUN_23a37a020(DAT_23ed6ccc0,_DAT_23eea8ca0);
      if ((plVar10 != (longlong *)0x0) && (lVar14 = *plVar10, lVar14 != 0)) goto LAB_23e1232a3;
      FUN_23e915740(param_1,&local_68,_DAT_23eea8ca0);
      local_70 = local_68;
      plVar10 = local_58;
      uVar16 = local_60;
    }
...
joined_r0x00023e12366a:
  ...
  if (_DAT_23eeaafb0 == plVar8) {
    *plVar8 = *plVar8 + -1;
    if (*plVar8 == 0) {
      (**(code **)(plVar8[1] + 0x30))(plVar8);
    }
    _DAT_23eeaafb0 = (longlong *)0x0;
  }
  lVar7 = *(longlong *)(*(longlong *)(param_1 + 0x38) + 8);
  plVar8 = *(longlong **)(lVar7 + 0x28);
