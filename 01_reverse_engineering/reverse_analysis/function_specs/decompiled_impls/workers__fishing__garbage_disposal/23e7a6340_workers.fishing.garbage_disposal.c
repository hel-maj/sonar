/* ===== 23e7a6340 workers.fishing.garbage_disposal:501 ===== */
/* ghidra_name=FUN_23e7a6340 entry=23e7a6340 size=1556 */

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

code * FUN_23e7a6340(longlong param_1)

{
  ...
  plVar7 = _DAT_23eedabc0;
  if (_DAT_23eedabc0 == (longlong *)0x0) {
LAB_23e7a6377:
    _DAT_23eedabc0 = (longlong *)FUN_23e91f3b0(param_1,DAT_23eedabb8,DAT_23eedacf8,8);
  }
  else {
    lVar9 = *_DAT_23eedabc0;
    if (1 < lVar9) {
      *_DAT_23eedabc0 = lVar9 + -1;
      goto LAB_23e7a6377;
    }
    if (_DAT_23eedabc0[2] != 0) {
      *_DAT_23eedabc0 = lVar9 + -1;
      if (lVar9 + -1 == 0) {
  ...
  plVar2 = _DAT_23eedabc0;
  lVar9 = *(longlong *)(param_1 + 0x38);
  plVar7 = _DAT_23eedabc0 + 9;
  lVar1 = *(longlong *)(lVar9 + 8);
  _DAT_23eedabc0[0xf] = lVar1;
  ...
  *(undefined4 *)(plVar2 + 8) = 0;
  ...
  if ((plVar7 == (longlong *)0x0) || (lVar9 = *plVar7, lVar9 == 0)) {
    ...
    *(undefined4 *)(plVar2 + 5) = 0x1f7;
    plVar7 = (longlong *)FUN_23e94bb80(param_1,lVar9,_DAT_23eed8710);
    if (plVar7 == (longlong *)0x0) {
    ...
    *plVar7 = *plVar7 + -1;
    ...
    lVar9 = *(longlong *)(DAT_23eed8080 + 0x20);
    if (*(char *)(lVar9 + 10) == '\0') {
      plVar7 = (longlong *)FUN_23a37a020(DAT_23eed8080,DAT_23eed8718);
      if (plVar7 == (longlong *)0x0) goto LAB_23e7a65c9;
      lVar9 = *plVar7;
LAB_23e7a6858:
      if (lVar9 == 0) goto LAB_23e7a65c9;
    }
    else {
      iVar6 = *(int *)(lVar9 + 0xc);
      if (*(int *)(lVar9 + 0xc) == 0) {
        *(int *)(lVar9 + 0xc) = _DAT_23ec15418;
        iVar6 = _DAT_23ec15418;
        _DAT_23ec15418 = _DAT_23ec15418 + 1;
      }
      if (_DAT_23ec153fc != iVar6) {
        _DAT_23ec153fc = iVar6;
        _DAT_23eedabb0 = FUN_23e8cbd60(lVar9,DAT_23eed8718,*(undefined8 *)(DAT_23eed8718 + 0x18));
      }
      if (-1 < _DAT_23eedabb0) {
        lVar1 = lVar9 + 0x20 + (1L << (*(byte *)(lVar9 + 9) & 0x3f));
        if (*(longlong *)(lVar1 + 8 + _DAT_23eedabb0 * 0x10) != 0) goto LAB_23e7a64c6;
        _DAT_23eedabb0 = FUN_23e8cbd60(lVar9,DAT_23eed8718,*(undefined8 *)(DAT_23eed8718 + 0x18));
        if (-1 < _DAT_23eedabb0) {
          lVar9 = *(longlong *)(lVar1 + 8 + _DAT_23eedabb0 * 0x10);
          goto LAB_23e7a6858;
        }
      }
LAB_23e7a65c9:
      plVar7 = (longlong *)FUN_23a37a020(DAT_23ed6ccc0,DAT_23eed8718);
      if ((plVar7 == (longlong *)0x0) || (*plVar7 == 0)) {
        uVar12 = 0x1fd;
        unaff_RSI = (longlong *)0x0;
        FUN_23e915740(param_1,&uStack_68,DAT_23eed8718);
        plVar7 = plStack_58;
        uVar10 = uStack_68;
        uVar11 = uStack_60;
        goto LAB_23e7a6615;
...
LAB_23e7a64c6:
    *(undefined4 *)(plVar2 + 5) = 0x1fd;
    unaff_RSI = (longlong *)FUN_23e91a870(param_1);
    if (unaff_RSI != (longlong *)0x0) {
      *(undefined4 *)(plVar2 + 5) = 0x1fe;
      plVar7 = (longlong *)FUN_23e91bfe0(param_1,unaff_RSI,DAT_23eed8720);
      if (plVar7 != (longlong *)0x0) {
        *plVar7 = *plVar7 + -1;
        if (*plVar7 == 0) {
          (**(code **)(plVar7[1] + 0x30))(plVar7);
...
LAB_23e7a6615:
  ...
  FUN_23e8bba40(plVar2,&DAT_23ec5dc90,unaff_RSI);
  if (_DAT_23eedabc0 == plVar2) {
    *plVar2 = *plVar2 + -1;
    if (*plVar2 == 0) {
      (**(code **)(plVar2[1] + 0x30))(plVar2);
    }
    _DAT_23eedabc0 = (longlong *)0x0;
  }
  lVar9 = *(longlong *)(*(longlong *)(param_1 + 0x38) + 8);
  plVar7 = *(longlong **)(lVar9 + 0x28);
  plVar2 = (longlong *)plVar7[2];
