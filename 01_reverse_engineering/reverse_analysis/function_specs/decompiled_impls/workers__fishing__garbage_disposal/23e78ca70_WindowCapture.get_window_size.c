/* ===== 23e78ca70 workers.fishing.garbage_disposal:64 ===== */
/* ghidra_name=FUN_23e78ca70 entry=23e78ca70 size=3216 */

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

longlong * FUN_23e78ca70(longlong param_1,undefined8 param_2,undefined8 *param_3)

{
  ...
  plVar11 = _DAT_23eedacb8;
  plVar1 = (longlong *)*param_3;
  plStack_68 = (longlong *)0x0;
  auStack_78._0_8_ = 0;
  auStack_78._8_8_ = 0;
  if (_DAT_23eedacb8 == (longlong *)0x0) {
LAB_23e78cac4:
    _DAT_23eedacb8 = (longlong *)FUN_23e91f3b0(param_1,DAT_23eedacb0,DAT_23eedacf8,0x28);
  }
  else {
    lVar12 = *_DAT_23eedacb8;
    if (1 < lVar12) {
      *_DAT_23eedacb8 = lVar12 + -1;
      goto LAB_23e78cac4;
    }
    if (_DAT_23eedacb8[2] != 0) {
      *_DAT_23eedacb8 = lVar12 + -1;
      if (lVar12 + -1 == 0) {
  ...
  plVar3 = _DAT_23eedacb8;
  lVar12 = *(longlong *)(param_1 + 0x38);
  plVar11 = _DAT_23eedacb8 + 9;
  lVar2 = *(longlong *)(lVar12 + 8);
  _DAT_23eedacb8[0xf] = lVar2;
...
LAB_23e78d360:
  ...
  if (iVar9 == 0) {
LAB_23e78cb87:
    plVar17 = _DAT_23eed8120;
    plVar16 = (longlong *)0x0;
    plVar14 = (longlong *)0x0;
    plVar13 = (longlong *)0x0;
    plVar11 = (longlong *)0x0;
    *_DAT_23eed8120 = *_DAT_23eed8120 + 1;
LAB_23e78cb9c:
  ...
  lVar12 = FUN_23e8dfc00();
  if (lVar12 == 0) {
    FUN_23e915740(param_1,auStack_78,DAT_23eed80c0);
  }
  else {
    plVar13 = (longlong *)FUN_23e8bc2f0(lVar12,_DAT_23eed8118);
    ...
    plVar11 = (longlong *)FUN_23e8bc2f0(plVar1,DAT_23eed80a8);
    if (plVar11 != (longlong *)0x0) {
      ...
      *plVar14 = *plVar14 + -1;
      ...
      if (uVar10 == 0xffffffff) goto LAB_23e78d360;
      if ((uVar10 & 1) == 0) goto LAB_23e78cb87;
      lVar12 = FUN_23e8dfc00();
      if (lVar12 == 0) {
        FUN_23e915740(param_1,auStack_78,DAT_23eed80c0);
        plVar17 = plStack_68;
        ...
        plVar11 = (longlong *)FUN_23e8bc2f0(lVar12,_DAT_23eed8128);
        if (plVar11 != (longlong *)0x0) {
...
LAB_23e78d0f2:
  ...
  if (_DAT_23eedacb8 == plVar3) {
    *plVar3 = *plVar3 + -1;
    if (*plVar3 == 0) {
      (**(code **)(plVar3[1] + 0x30))(plVar3);
    }
    _DAT_23eedacb8 = (longlong *)0x0;
  }
  lVar12 = *(longlong *)(*(longlong *)(param_1 + 0x38) + 8);
  plVar3 = *(longlong **)(lVar12 + 0x28);
