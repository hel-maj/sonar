/* ===== 23e78ac30 workers.fishing.garbage_disposal:38 ===== */
/* ghidra_name=FUN_23e78ac30 entry=23e78ac30 size=3953 */

code * FUN_23e78ac30(longlong param_1,undefined8 param_2,longlong *param_3)

{
  ...
  *(longlong **)(lVar10 + 8) = plVar19 + -2;
  uVar23 = DAT_23eed80b0;
  local_68[0] = (longlong *)0x0;
  local_78 = (undefined1  [16])0x0;
  *plVar19 = lVar21;
  local_88 = plVar19;
  plVar8 = (longlong *)
           FUN_23e93e1e0(FUN_23e78bc10,uVar23,uVar3,DAT_23eedacd8,0,0,uVar4,0,&local_88,1);
  ...
  *(longlong **)(lVar10 + 8) = plVar17 + -2;
  if (plVar9 != (longlong *)0x0) {
    lVar10 = *plVar9;
    if (lVar10 < 2) {
      if (plVar9[2] == 0) goto LAB_23e78ae2b;
      *plVar9 = lVar10 + -1;
      if (lVar10 + -1 == 0) {
  ...
  plVar9 = (longlong *)FUN_23e91f3b0(param_1,DAT_23eedace0,DAT_23eedacf8,0x28);
  DAT_23eedace8 = plVar9;
LAB_23e78ae2b:
  ...
  *(undefined4 *)(plVar9 + 8) = 0;
  ...
  if (lVar10 == 0) {
    ...
    *(undefined4 *)(plVar9 + 5) = 0x34;
    local_88 = plVar8;
    local_80 = plVar17;
    plVar11 = (longlong *)FUN_23e954670(param_1,lVar10,DAT_23eed80c8,&local_88);
    if (plVar11 == (longlong *)0x0) {
          ...
          if (plVar13 == (longlong *)0x0) {
            ...
            if (cVar6 == '\0') {
              ...
              *(undefined1 (*) [16])(param_1 + 0x60) = (undefined1  [16])0x0;
              ...
              local_68[0] = (longlong *)0x0;
              local_78 = (undefined1  [16])0x0;
              if (local_a8 == (longlong *)0x0) goto LAB_23e78b32a;
              uVar20 = 0x39;
              goto LAB_23e78b300;
            }
            lVar10 = *(longlong *)(*(longlong *)(param_1 + 0x38) + 8);
...
LAB_23e78b5cc:
          ...
          *plVar16 = lVar10;
          ...
          if (iVar7 != 0) {
            if (plVar19[2] == 0) {
              ...
              *(longlong *)local_78._0_8_ = *(longlong *)local_78._0_8_ + 1;
              ...
              cVar6 = FUN_23e8d9ac0(plVar19[2],DAT_23eed80a8,plVar15);
          ...
          if ((((*(int *)(*(longlong *)(lVar10 + 0x28) + 0x160) != 0) ||
             ...
             (pcVar18 = *(code **)(param_1 + 0x60), pcVar18 != (code *)0x0)) goto LAB_23e78b2ba;
...
LAB_23e78b32a:
  ...
  if (DAT_23eedace8 == plVar9) {
    *plVar9 = *plVar9 + -1;
    if (*plVar9 == 0) {
      (**(code **)(plVar9[1] + 0x30))(plVar9);
    }
    DAT_23eedace8 = (longlong *)0x0;
  }
  lVar10 = *(longlong *)(*(longlong *)(param_1 + 0x38) + 8);
  plVar9 = *(longlong **)(lVar10 + 0x28);
  plVar15 = (longlong *)plVar9[2];
