/* ===== 23c6244a0 license.license_client:75 ===== */
/* ghidra_name=FUN_23c6244a0 entry=23c6244a0 size=1172 */

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

longlong FUN_23c6244a0(longlong param_1,undefined8 param_2,undefined8 *param_3)

{
  ...
  plVar8 = _DAT_23ee29ce0;
  plVar1 = (longlong *)*param_3;
  plVar2 = (longlong *)param_3[1];
  if (_DAT_23ee29ce0 != (longlong *)0x0) {
    lVar10 = *_DAT_23ee29ce0;
    if (lVar10 < 2) {
      if (_DAT_23ee29ce0[2] == 0) goto LAB_23c624504;
      *_DAT_23ee29ce0 = lVar10 + -1;
      if (lVar10 + -1 == 0) {
  ...
  _DAT_23ee29ce0 = (longlong *)FUN_23e91f3b0(param_1,_DAT_23ee29cd8,DAT_23ee29d18,0x10);
LAB_23c624504:
  plVar4 = _DAT_23ee29ce0;
  lVar10 = *(longlong *)(param_1 + 0x38);
  plVar8 = _DAT_23ee29ce0 + 9;
  lVar3 = *(longlong *)(lVar10 + 8);
  _DAT_23ee29ce0[0xf] = lVar3;
  ...
  *(undefined4 *)(plVar4 + 8) = 0;
  ...
  if (plVar8 != (longlong *)0x0) {
    *(undefined4 *)(plVar4 + 5) = 0x4d;
    plVar9 = (longlong *)FUN_23e915840(param_1,plVar8,_DAT_23ee28438,plVar2);
    *plVar8 = *plVar8 + -1;
    if (*plVar8 == 0) {
      (**(code **)(plVar8[1] + 0x30))(plVar8);
    }
    if (plVar9 != (longlong *)0x0) {
      plVar8 = (longlong *)FUN_23e8bc2f0(plVar9,_DAT_23ee28440);
      *plVar9 = *plVar9 + -1;
      if (*plVar9 == 0) {
      ...
      if (plVar8 != (longlong *)0x0) {
        *(undefined4 *)(plVar4 + 5) = 0x4d;
        lVar10 = FUN_23e94bb80(param_1,plVar8,DAT_23ee28428);
        *plVar8 = *plVar8 + -1;
        if (*plVar8 == 0) {
          (**(code **)(plVar8[1] + 0x30))(plVar8);
        }
  ...
  *(undefined1 (*) [16])(param_1 + 0x60) = (undefined1  [16])0x0;
  ...
  if (_DAT_23ee29ce0 == plVar4) {
    *plVar4 = *plVar4 + -1;
    if (*plVar4 == 0) {
      (**(code **)(plVar4[1] + 0x30))(plVar4);
    }
    _DAT_23ee29ce0 = (longlong *)0x0;
  }
